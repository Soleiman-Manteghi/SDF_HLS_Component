...
// SystemVerilog created from i_iowr_nb_return_pwappersalways_unnamed_pwappersalways6_pwappersalways0
...
module PWappersalways_i_iowr_nb_return_pwappers0000ays6_pwappersalways0 (
    ...
    assign out_iowr_nb_return_PWappersalways_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_PWappersalways_o_fifovalid = iowr_nb_o_fifovalid;
