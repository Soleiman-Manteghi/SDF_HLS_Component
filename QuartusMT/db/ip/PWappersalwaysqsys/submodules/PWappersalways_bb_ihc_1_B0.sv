...
module PWappersalways_bb_ihc_1_B0 (
    ...
    PWappersalways_ihc_1_B0_merge theihc_1_B0_merge (
    ...
    PWappersalways_ihc_1_B0_branch theihc_1_B0_branch (
    ...
    PWappersalways_bb_ihc_1_B0_stall_region thebb_ihc_1_B0_stall_region (
