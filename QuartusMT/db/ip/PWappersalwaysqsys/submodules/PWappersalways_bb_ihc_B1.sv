...
module PWappersalways_bb_ihc_B1 (
    ...
    PWappersalways_ihc_B1_branch theihc_B1_branch (
    ...
    PWappersalways_bb_ihc_B1_stall_region thebb_ihc_B1_stall_region (
    ...
    PWappersalways_ihc_B1_merge theihc_B1_merge (
