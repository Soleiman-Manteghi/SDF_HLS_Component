...
// SystemVerilog created from i_iowr_bl_s2_unnamed_ihc_14_ihc_10
...
module PWappersalways_i_iowr_bl_s2_unnamed_ihc_14_ihc_10 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_s2_i_fifoready;
    assign iowr_i_fifosize = c32_0_q;
    assign iowr_i_packetempty = c32_0_q;
    assign iowr_i_predicate = in_c0_exe18;
    ...
    assign out_iowr_bl_s2_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,8)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,11)
    assign out_iowr_bl_s2_o_fifovalid = iowr_o_fifovalid;
