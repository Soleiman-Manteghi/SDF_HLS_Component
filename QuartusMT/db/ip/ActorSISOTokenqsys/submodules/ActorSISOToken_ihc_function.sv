...
module ActorSISOToken_ihc_function (
    ...
    wire [0:0] bb_ihc_B1_out_iord_bl_s0_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s0_o_fifoready;
    ...
    ActorSISOToken_i_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo (
    ...
    ActorSISOToken_i_llvm_fpga_pipeline_keep_going_ihc2_sr thei_llvm_fpga_pipeline_keep_going_ihc2_sr (
        .in_i_data(GND_q),
    ...
    ActorSISOToken_arbiter_iowr_s1 thearbiter_iowr_s1 (
    ...
    ActorSISOToken_bb_ihc_B1 thebb_ihc_B1 (
        .in_forked_0(GND_q),
        ...
        .out_iord_bl_s0_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s0_o_fifoalmost_full),
        .out_iord_bl_s0_o_fifoready(bb_ihc_B1_out_iord_bl_s0_o_fifoready),
    ...
    ActorSISOToken_bb_ihc_B0 thebb_ihc_B0 (
    ...
    ActorSISOToken_bb_ihc_B1_sr_1 thebb_ihc_B1_sr_1_aunroll_x (
    ...
    assign out_iord_bl_s0_o_fifoalmost_full = bb_ihc_B1_out_iord_bl_s0_o_fifoalmost_full;

    // out_iord_bl_s0_o_fifoready(GPOUT,29)
    assign out_iord_bl_s0_o_fifoready = bb_ihc_B1_out_iord_bl_s0_o_fifoready;

    // out_iowr_s1_o_fifodata(GPOUT,30)
    assign out_iowr_s1_o_fifodata = arbiter_iowr_s1_out_o_fifodata;

    // out_iowr_s1_o_fifovalid(GPOUT,31)
