...
module ActorSISOToken_bb_ihc_B0 (
    ...
    ActorSISOToken_ihc_B0_merge theihc_B0_merge (
    ...
    ActorSISOToken_ihc_B0_branch theihc_B0_branch (
    ...
    ActorSISOToken_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
