...
module ActorSISOToken_bb_ihc_B1 (
    ...
    ActorSISOToken_ihc_B1_branch theihc_B1_branch (
    ...
    ActorSISOToken_ihc_B1_merge theihc_B1_merge (
    ...
    ActorSISOToken_bb_ihc_B1_stall_region thebb_ihc_B1_stall_region (
