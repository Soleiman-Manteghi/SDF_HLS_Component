...
// SystemVerilog created from i_iowr_nb_return_actorsisotoken_unnamed_actorsisotoken4_actorsisotoken0
...
module ActorSISOToken_i_iowr_nb_return_actorsis0000ken4_actorsisotoken0 (
    ...
    assign out_iowr_nb_return_ActorSISOToken_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_ActorSISOToken_o_fifovalid = iowr_nb_o_fifovalid;
