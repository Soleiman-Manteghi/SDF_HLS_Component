...
module ActorSIMOToken3_bb_ihc_B0 (
    ...
    ActorSIMOToken3_ihc_B0_merge theihc_B0_merge (
    ...
    ActorSIMOToken3_ihc_B0_branch theihc_B0_branch (
    ...
    ActorSIMOToken3_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
