...
module ActorSIMOToken3_ihc_1_function (
    ...
    ActorSIMOToken3_i_llvm_fpga_pipeline_kee0000ng_ihc_12_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc_12_valid_fifo (
    ...
    ActorSIMOToken3_i_llvm_fpga_pipeline_keep_going_ihc_12_sr thei_llvm_fpga_pipeline_keep_going_ihc_12_sr (
        .in_i_data(GND_q),
    ...
    ActorSIMOToken3_arbiter_iowr_s2 thearbiter_iowr_s2 (
    ...
    ActorSIMOToken3_arbiter_iowr_s1 thearbiter_iowr_s1 (
    ...
    ActorSIMOToken3_bb_ihc_1_B1 thebb_ihc_1_B1 (
        .in_forked_0(GND_q),
    ...
    ActorSIMOToken3_bb_ihc_1_B0 thebb_ihc_1_B0 (
    ...
    ActorSIMOToken3_bb_ihc_1_B1_sr_1 thebb_ihc_1_B1_sr_1_aunroll_x (
