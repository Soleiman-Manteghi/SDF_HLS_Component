...
// SystemVerilog created from i_iord_bl_s2_unnamed_ihc2_ihc0
...
module ActorSIMOToken3_i_iord_bl_s2_unnamed_ihc2_ihc0 (
    ...
    ActorSIMOToken3_reg_rsrvd_fix thereg_rsrvd_fix (
