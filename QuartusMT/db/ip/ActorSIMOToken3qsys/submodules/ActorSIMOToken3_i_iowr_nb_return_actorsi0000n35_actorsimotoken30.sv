...
// SystemVerilog created from i_iowr_nb_return_actorsimotoken3_unnamed_actorsimotoken35_actorsimotoken30
...
module ActorSIMOToken3_i_iowr_nb_return_actorsi0000n35_actorsimotoken30 (
    ...
    assign out_iowr_nb_return_ActorSIMOToken3_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_ActorSIMOToken3_o_fifovalid = iowr_nb_o_fifovalid;
