...
// SystemVerilog created from ActorSIMOToken3_function_wrapper
...
module ActorSIMOToken3_function_wrapper (
    input wire [0:0] avst_iord_bl_call_ActorSIMOToken3_data,
    input wire [0:0] avst_iord_bl_call_ActorSIMOToken3_valid,
    ...
    input wire [0:0] avst_iowr_nb_return_ActorSIMOToken3_almostfull,
    input wire [0:0] avst_iowr_s1_almost_full,
    input wire [0:0] avst_iowr_s1_ready,
    input wire [0:0] stall_in,
    input wire [0:0] start,
    input wire [0:0] valid_in,
    output wire [0:0] avst_iord_bl_call_ActorSIMOToken3_almost_full,
    output wire [0:0] avst_iord_bl_call_ActorSIMOToken3_ready,
    output wire [0:0] avst_iord_bl_s0_almost_full,
    output wire [0:0] avst_iord_bl_s0_ready,
    output wire [0:0] avst_iowr_nb_return_ActorSIMOToken3_data,
    output wire [0:0] avst_iowr_nb_return_ActorSIMOToken3_valid,
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [0:0] ActorSIMOToken3_function_out_iord_bl_call_ActorSIMOToken3_o_fifoalmost_full;
    wire [0:0] ActorSIMOToken3_function_out_iord_bl_call_ActorSIMOToken3_o_fifoready;
    wire [0:0] ActorSIMOToken3_function_out_iowr_bl_call_ihc_1_o_fifodata;
    wire [0:0] ActorSIMOToken3_function_out_iowr_bl_call_ihc_1_o_fifovalid;
    wire [0:0] ActorSIMOToken3_function_out_iowr_bl_call_ihc_o_fifodata;
    wire [0:0] ActorSIMOToken3_function_out_iowr_bl_call_ihc_o_fifovalid;
    wire [0:0] ActorSIMOToken3_function_out_iowr_nb_return_ActorSIMOToken3_o_fifodata;
    wire [0:0] ActorSIMOToken3_function_out_iowr_nb_return_ActorSIMOToken3_o_fifovalid;
    ...
    ActorSIMOToken3_iowr_s2_fifo_inst theiowr_s2_fifo_inst (
    ...
    ActorSIMOToken3_ihc_function theihc_function (
        .in_arg_call(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_iord_bl_call_ihc_i_fifodata(ActorSIMOToken3_function_out_iowr_bl_call_ihc_o_fifodata),
        .in_iord_bl_call_ihc_i_fifovalid(ActorSIMOToken3_function_out_iowr_bl_call_ihc_o_fifovalid),
    ...
    ActorSIMOToken3_iowr_s1_fifo_inst theiowr_s1_fifo_inst (
    ...
    ActorSIMOToken3_iord_bl_s0_fifo_inst theiord_bl_s0_fifo_inst (
    ...
    ActorSIMOToken3_ihc_1_function theihc_1_function (
        .in_arg_call(call_const_q),
        .in_arg_s0_global(call_const_q),
        .in_arg_s1_global(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_iord_bl_call_ihc_1_i_fifodata(ActorSIMOToken3_function_out_iowr_bl_call_ihc_1_o_fifodata),
        .in_iord_bl_call_ihc_1_i_fifovalid(ActorSIMOToken3_function_out_iowr_bl_call_ihc_1_o_fifovalid),
    ...
    // ActorSIMOToken3_function(BLACKBOX,2)
    ActorSIMOToken3_function theActorSIMOToken3_function (
        .in_arg_call(call_const_q),
        .in_arg_return(call_const_q),
        .in_iord_bl_call_ActorSIMOToken3_i_fifodata(avst_iord_bl_call_ActorSIMOToken3_data),
        .in_iord_bl_call_ActorSIMOToken3_i_fifovalid(VCC_q),
        ...
        .in_stall_in(GND_q),
        .in_valid_in(VCC_q),
        .out_iord_bl_call_ActorSIMOToken3_o_fifoalmost_full(ActorSIMOToken3_function_out_iord_bl_call_ActorSIMOToken3_o_fifoalmost_full),
        .out_iord_bl_call_ActorSIMOToken3_o_fifoready(ActorSIMOToken3_function_out_iord_bl_call_ActorSIMOToken3_o_fifoready),
        .out_iowr_bl_call_ihc_1_o_fifodata(ActorSIMOToken3_function_out_iowr_bl_call_ihc_1_o_fifodata),
        .out_iowr_bl_call_ihc_1_o_fifovalid(ActorSIMOToken3_function_out_iowr_bl_call_ihc_1_o_fifovalid),
        .out_iowr_bl_call_ihc_o_fifodata(ActorSIMOToken3_function_out_iowr_bl_call_ihc_o_fifodata),
        .out_iowr_bl_call_ihc_o_fifovalid(ActorSIMOToken3_function_out_iowr_bl_call_ihc_o_fifovalid),
        .out_iowr_nb_return_ActorSIMOToken3_o_fifodata(ActorSIMOToken3_function_out_iowr_nb_return_ActorSIMOToken3_o_fifodata),
        .out_iowr_nb_return_ActorSIMOToken3_o_fifovalid(ActorSIMOToken3_function_out_iowr_nb_return_ActorSIMOToken3_o_fifovalid),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // avst_iord_bl_call_ActorSIMOToken3_almost_full(GPOUT,27)
    assign avst_iord_bl_call_ActorSIMOToken3_almost_full = ActorSIMOToken3_function_out_iord_bl_call_ActorSIMOToken3_o_fifoalmost_full;

    // avst_iord_bl_call_ActorSIMOToken3_ready(GPOUT,28)
    assign avst_iord_bl_call_ActorSIMOToken3_ready = ActorSIMOToken3_function_out_iord_bl_call_ActorSIMOToken3_o_fifoready;
    ...
    // avst_iowr_nb_return_ActorSIMOToken3_data(GPOUT,31)
    assign avst_iowr_nb_return_ActorSIMOToken3_data = ActorSIMOToken3_function_out_iowr_nb_return_ActorSIMOToken3_o_fifodata;

    // avst_iowr_nb_return_ActorSIMOToken3_valid(GPOUT,32)
    assign avst_iowr_nb_return_ActorSIMOToken3_valid = ActorSIMOToken3_function_out_iowr_nb_return_ActorSIMOToken3_o_fifovalid;
