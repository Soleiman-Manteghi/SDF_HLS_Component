...
module ActorSIMOToken3_bb_ihc_B1 (
    ...
    ActorSIMOToken3_ihc_B1_branch theihc_B1_branch (
    ...
    ActorSIMOToken3_ihc_B1_merge theihc_B1_merge (
    ...
    ActorSIMOToken3_bb_ihc_B1_stall_region thebb_ihc_B1_stall_region (
