...
module ActorSIMOToken3_bb_ihc_B1_stall_region (
    ...
    reg [0:0] redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_q;
    ...
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireStall;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_StallValid;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_toReg0;
    reg [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg0;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_consumed0;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_toReg1;
    reg [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg1;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_consumed1;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_or0;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_backStall;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_V0;
    wire [0:0] SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_V1;
    ...
    reg [0:0] SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_R_v_0;
    wire [0:0] SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_v_s_0;
    wire [0:0] SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_s_tv_0;
    wire [0:0] SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_backEN;
    wire [0:0] SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_backStall;
    wire [0:0] SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_V0;
    ...
    // ihc_B1_merge_reg_aunroll_x(BLACKBOX,39)@0
    // in in_stall_in@20000000
    // out out_stall_out@20000000
    // out out_valid_out@1
    // out out_data_out_0_tpl@1
    ActorSIMOToken3_ihc_B1_merge_reg theihc_B1_merge_reg_aunroll_x (
    ...
    // i_sfc_s_c0_in_while_body_ihcs_c0_enter1_ihc1_aunroll_x(BLACKBOX,36)@1
    ...
    ActorSIMOToken3_i_sfc_s_c0_in_while_body_ihcs_c0_enter1_ihc1 thei_sfc_s_c0_in_while_body_ihcs_c0_enter1_ihc1_aunroll_x (
    ...
    // SE_out_i_sfc_s_c0_in_while_body_ihcs_c0_enter1_ihc1_aunroll_x(STALLENABLE,76)
    // Valid signal propagation
    ...
    // out out_o_stall@20000000
    // out out_o_valid@7
    ActorSIMOToken3_i_iord_bl_s2_unnamed_ihc3_ihc0 thei_iord_bl_s2_unnamed_ihc3_ihc6 (
    ...
    // SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6(STALLENABLE,68)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg0 <= '0;
            SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg1 <= '0;
        end
        else
        begin
            // Successor 0
            SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg0 <= SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_toReg0;
            // Successor 1
            SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg1 <= SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_toReg1;
        end
    end
    // Input Stall processing
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_consumed0 = (~ (in_stall_in) & SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireValid) | SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg0;
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_consumed1 = (~ (SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_backStall) & SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireValid) | SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg1;
    // Consuming
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_StallValid = SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_backStall & SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireValid;
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_toReg0 = SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_StallValid & SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_consumed0;
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_toReg1 = SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_StallValid & SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_consumed1;
    // Backward Stall generation
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_or0 = SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_consumed0;
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireStall = ~ (SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_consumed1 & SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_or0);
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_backStall = SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireStall;
    // Valid signal propagation
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_V0 = SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireValid & ~ (SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg0);
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_V1 = SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireValid & ~ (SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_fromReg1);
    // Computing multiple Valid(s)
    assign SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_wireValid = i_iord_bl_s2_unnamed_ihc3_ihc6_out_o_valid;

    // SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0(STALLENABLE,81)
    // Valid signal propagation
    assign SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_V0 = SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_R_v_0;
    // Stall signal propagation
    assign SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_s_tv_0 = i_llvm_fpga_push_i1_memdep_phi_push3_ihc8_out_stall_out & SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_R_v_0;
    // Backward Enable generation
    assign SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_backEN = ~ (SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_s_tv_0);
    // Determine whether to write valid data into the first register stage
    assign SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_v_s_0 = SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_backEN & SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_V1;
    // Backward Stall generation
    assign SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_backStall = ~ (SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_v_s_0);
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_R_v_0 <= 1'b0;
        end
        else
        begin
            if (SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_backEN == 1'b0)
            begin
                SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_R_v_0 <= SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_R_v_0 & SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_s_tv_0;
            end
            else
            begin
                SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_R_v_0 <= SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_v_s_0;
            end

        end
    end

    // SE_out_i_llvm_fpga_push_i1_memdep_phi_push3_ihc8(STALLENABLE,72)
    // Backward Stall generation
    ...
    // bubble_join_i_iord_bl_s2_unnamed_ihc3_ihc6(BITJOIN,48)
    assign bubble_join_i_iord_bl_s2_unnamed_ihc3_ihc6_q = i_iord_bl_s2_unnamed_ihc3_ihc6_out_o_data;

    // bubble_select_i_iord_bl_s2_unnamed_ihc3_ihc6(BITSELECT,49)
    assign bubble_select_i_iord_bl_s2_unnamed_ihc3_ihc6_b = $unsigned(bubble_join_i_iord_bl_s2_unnamed_ihc3_ihc6_q[31:0]);

    // i_toi1_intcast1_ihc7_sel_x(BITSELECT,37)@7
    assign i_toi1_intcast1_ihc7_sel_x_b = bubble_select_i_iord_bl_s2_unnamed_ihc3_ihc6_b[0:0];

    // redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0(REG,43)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_q <= $unsigned(1'b0);
        end
        else if (SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_backEN == 1'b1)
        begin
            redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_q <= $unsigned(i_toi1_intcast1_ihc7_sel_x_b);
        end
    end

    // i_llvm_fpga_push_i1_memdep_phi_push3_ihc8(BLACKBOX,10)@8
    // in in_stall_in@20000000
    // out out_data_out@9
    ...
    // out out_stall_out@20000000
    // out out_valid_out@9
    ActorSIMOToken3_i_llvm_fpga_push_i1_memdep_phi_push3_ihc0 thei_llvm_fpga_push_i1_memdep_phi_push3_ihc8 (
        .in_data_in(redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_q),
        ...
        .in_valid_in(SE_redist0_i_toi1_intcast1_ihc7_sel_x_b_1_0_V0),
        .out_data_out(),
    ...
    // bubble_join_i_sfc_s_c0_in_while_body_ihcs_c0_enter1_ihc1_aunroll_x(BITJOIN,59)
    ...
    // bubble_select_i_sfc_s_c0_in_while_body_ihcs_c0_enter1_ihc1_aunroll_x(BITSELECT,60)
    ...
    // i_llvm_fpga_pop_i1_memdep_phi_pop3_ihc3(BLACKBOX,9)@4
    // in in_stall_in@20000000
    // out out_data_out@5
    // out out_feedback_stall_out_3@20000000
    // out out_stall_out@20000000
    // out out_valid_out@5
    ActorSIMOToken3_i_llvm_fpga_pop_i1_memdep_phi_pop3_ihc0 thei_llvm_fpga_pop_i1_memdep_phi_pop3_ihc3 (
        .in_data_in(GND_q),
    ...
    // SE_out_i_llvm_fpga_pop_i1_memdep_phi_pop3_ihc3(STALLENABLE,70)
    // Valid signal propagation
    ...
    // SE_out_i_iord_bl_s2_unnamed_ihc2_ihc4(STALLENABLE,66)
    // Valid signal propagation
    ...
    // bubble_join_i_llvm_fpga_pop_i1_memdep_phi_pop3_ihc3(BITJOIN,52)
    assign bubble_join_i_llvm_fpga_pop_i1_memdep_phi_pop3_ihc3_q = i_llvm_fpga_pop_i1_memdep_phi_pop3_ihc3_out_data_out;

    // bubble_select_i_llvm_fpga_pop_i1_memdep_phi_pop3_ihc3(BITSELECT,53)
    ...
    // i_iord_bl_s2_unnamed_ihc2_ihc4(BLACKBOX,7)@5
    // in in_i_stall@20000000
    ...
    // out out_o_stall@20000000
    // out out_o_valid@6
    ActorSIMOToken3_i_iord_bl_s2_unnamed_ihc2_ihc0 thei_iord_bl_s2_unnamed_ihc2_ihc4 (
    ...
    // dupName_0_sync_out_x(GPOUT,34)@7
    assign out_valid_out = SE_out_i_iord_bl_s2_unnamed_ihc3_ihc6_V0;
