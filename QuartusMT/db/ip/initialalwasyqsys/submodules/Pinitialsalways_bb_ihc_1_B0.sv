...
module Pinitialsalways_bb_ihc_1_B0 (
    ...
    Pinitialsalways_ihc_1_B0_merge theihc_1_B0_merge (
    ...
    Pinitialsalways_ihc_1_B0_branch theihc_1_B0_branch (
    ...
    Pinitialsalways_bb_ihc_1_B0_stall_region thebb_ihc_1_B0_stall_region (
