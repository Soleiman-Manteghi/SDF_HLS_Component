...
module Pinitialsalways_ihc_function (
    ...
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_o_fifoready;
    wire [31:0] bb_ihc_B1_out_iowr_bl_s3_o_fifodata;
    wire [0:0] bb_ihc_B1_out_iowr_bl_s3_o_fifovalid;
    ...
    wire [1:0] c_i2_05_q;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_ihc1_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_ihc1_sr_out_o_valid;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo_out_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo_out_valid_out;
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo(BLACKBOX,12)
    Pinitialsalways_i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo (
        .in_data_in(c_i2_05_q),
        .in_stall_in(bb_ihc_B1_out_stall_out_0),
        .in_valid_in(i_llvm_fpga_pipeline_keep_going_ihc1_sr_out_o_valid),
        .out_almost_full(),
        .out_data_out(),
        .out_stall_out(i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo_out_stall_out),
        .out_valid_out(i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // i_llvm_fpga_pipeline_keep_going_ihc1_sr(BLACKBOX,11)
    Pinitialsalways_i_llvm_fpga_pipeline_keep_going_ihc1_sr thei_llvm_fpga_pipeline_keep_going_ihc1_sr (
        .in_i_data(GND_q),
        .in_i_stall(i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo_out_stall_out),
        .in_i_valid(bb_ihc_B1_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going_ihc1_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going_ihc1_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_ihc_B1(BLACKBOX,3)
    Pinitialsalways_bb_ihc_B1 thebb_ihc_B1 (
        ...
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going_ihc1_sr_out_o_stall),
        .in_stall_in_0(GND_q),
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo_out_valid_out),
        .in_valid_in_1(bb_ihc_B1_sr_1_aunroll_x_out_o_valid),
        .out_exiting_stall_out(),
        .out_exiting_valid_out(),
        .out_iord_bl_s2_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s2_o_fifoalmost_full),
        .out_iord_bl_s2_o_fifoready(bb_ihc_B1_out_iord_bl_s2_o_fifoready),
        .out_iowr_bl_s3_o_fifodata(bb_ihc_B1_out_iowr_bl_s3_o_fifodata),
        .out_iowr_bl_s3_o_fifovalid(bb_ihc_B1_out_iowr_bl_s3_o_fifovalid),
    ...
    Pinitialsalways_bb_ihc_B0 thebb_ihc_B0 (
    ...
    // bb_ihc_B1_sr_1_aunroll_x(BLACKBOX,32)
    Pinitialsalways_bb_ihc_B1_sr_1 thebb_ihc_B1_sr_1_aunroll_x (
    ...
    // out_iord_bl_call_ihc_o_fifoalmost_full(GPOUT,24)
    assign out_iord_bl_call_ihc_o_fifoalmost_full = bb_ihc_B0_out_iord_bl_call_ihc_o_fifoalmost_full;

    // out_iord_bl_call_ihc_o_fifoready(GPOUT,25)
    assign out_iord_bl_call_ihc_o_fifoready = bb_ihc_B0_out_iord_bl_call_ihc_o_fifoready;

    // out_iord_bl_s2_o_fifoalmost_full(GPOUT,26)
    assign out_iord_bl_s2_o_fifoalmost_full = bb_ihc_B1_out_iord_bl_s2_o_fifoalmost_full;

    // out_iord_bl_s2_o_fifoready(GPOUT,27)
    assign out_iord_bl_s2_o_fifoready = bb_ihc_B1_out_iord_bl_s2_o_fifoready;

    // out_iowr_bl_s3_o_fifodata(GPOUT,28)
    assign out_iowr_bl_s3_o_fifodata = bb_ihc_B1_out_iowr_bl_s3_o_fifodata;

    // out_iowr_bl_s3_o_fifovalid(GPOUT,29)
    assign out_iowr_bl_s3_o_fifovalid = bb_ihc_B1_out_iowr_bl_s3_o_fifovalid;
