...
module Pinitialsalways_bb_ihc_B0 (
    ...
    Pinitialsalways_ihc_B0_merge theihc_B0_merge (
    ...
    Pinitialsalways_ihc_B0_branch theihc_B0_branch (
    ...
    Pinitialsalways_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
