...
module Pinitialsalways_ihc_2_function (
    ...
    wire [31:0] bb_ihc_2_B1_out_iowr_bl_s1_o_fifodata;
    wire [0:0] bb_ihc_2_B1_out_iowr_bl_s1_o_fifovalid;
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc_22_valid_fifo(BLACKBOX,13)
    Pinitialsalways_i_llvm_fpga_pipeline_kee0000ng_ihc_22_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc_22_valid_fifo (
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc_22_sr(BLACKBOX,12)
    Pinitialsalways_i_llvm_fpga_pipeline_keep_going_ihc_22_sr thei_llvm_fpga_pipeline_keep_going_ihc_22_sr (
        .in_i_data(GND_q),
    ...
    Pinitialsalways_bb_ihc_2_B1 thebb_ihc_2_B1 (
        .in_forked_0(GND_q),
        ...
        .out_iowr_bl_s1_o_fifodata(bb_ihc_2_B1_out_iowr_bl_s1_o_fifodata),
        .out_iowr_bl_s1_o_fifovalid(bb_ihc_2_B1_out_iowr_bl_s1_o_fifovalid),
    ...
    Pinitialsalways_bb_ihc_2_B0 thebb_ihc_2_B0 (
    ...
    // bb_ihc_2_B1_sr_1_aunroll_x(BLACKBOX,33)
    Pinitialsalways_bb_ihc_2_B1_sr_1 thebb_ihc_2_B1_sr_1_aunroll_x (
    ...
    // out_iowr_bl_s1_o_fifodata(GPOUT,29)
    assign out_iowr_bl_s1_o_fifodata = bb_ihc_2_B1_out_iowr_bl_s1_o_fifodata;

    // out_iowr_bl_s1_o_fifovalid(GPOUT,30)
    assign out_iowr_bl_s1_o_fifovalid = bb_ihc_2_B1_out_iowr_bl_s1_o_fifovalid;
