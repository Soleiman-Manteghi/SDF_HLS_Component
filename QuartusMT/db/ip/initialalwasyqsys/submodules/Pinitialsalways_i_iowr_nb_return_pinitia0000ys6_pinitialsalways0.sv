...
// SystemVerilog created from i_iowr_nb_return_pinitialsalways_unnamed_pinitialsalways6_pinitialsalways0
...
module Pinitialsalways_i_iowr_nb_return_pinitia0000ys6_pinitialsalways0 (
    ...
    assign out_iowr_nb_return_Pinitialsalways_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_Pinitialsalways_o_fifovalid = iowr_nb_o_fifovalid;
