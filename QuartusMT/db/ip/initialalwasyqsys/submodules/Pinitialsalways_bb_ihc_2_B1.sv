...
module Pinitialsalways_bb_ihc_2_B1 (
    ...
    wire [31:0] bb_ihc_2_B1_stall_region_out_iowr_bl_s1_o_fifodata;
    wire [0:0] bb_ihc_2_B1_stall_region_out_iowr_bl_s1_o_fifovalid;
    ...
    Pinitialsalways_ihc_2_B1_branch theihc_2_B1_branch (
    ...
    Pinitialsalways_ihc_2_B1_merge theihc_2_B1_merge (
    ...
    Pinitialsalways_bb_ihc_2_B1_stall_region thebb_ihc_2_B1_stall_region (
        ...
        .out_iowr_bl_s1_o_fifodata(bb_ihc_2_B1_stall_region_out_iowr_bl_s1_o_fifodata),
        .out_iowr_bl_s1_o_fifovalid(bb_ihc_2_B1_stall_region_out_iowr_bl_s1_o_fifovalid),
    ...
    // out_iord_bl_s0_o_fifoalmost_full(GPOUT,15)
    assign out_iord_bl_s0_o_fifoalmost_full = bb_ihc_2_B1_stall_region_out_iord_bl_s0_o_fifoalmost_full;

    // out_iord_bl_s0_o_fifoready(GPOUT,16)
    assign out_iord_bl_s0_o_fifoready = bb_ihc_2_B1_stall_region_out_iord_bl_s0_o_fifoready;

    // out_iowr_bl_s1_o_fifodata(GPOUT,17)
    assign out_iowr_bl_s1_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_o_fifodata;

    // out_iowr_bl_s1_o_fifovalid(GPOUT,18)
    assign out_iowr_bl_s1_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_o_fifovalid;
