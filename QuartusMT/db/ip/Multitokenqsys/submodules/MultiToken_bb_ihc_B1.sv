...
module MultiToken_bb_ihc_B1 (
    ...
    wire [31:0] bb_ihc_B1_stall_region_out_iowr_bl_s3_0_o_fifodata;
    wire [0:0] bb_ihc_B1_stall_region_out_iowr_bl_s3_0_o_fifovalid;
    wire [31:0] bb_ihc_B1_stall_region_out_iowr_bl_s3_1_o_fifodata;
    wire [0:0] bb_ihc_B1_stall_region_out_iowr_bl_s3_1_o_fifovalid;
    ...
    MultiToken_bb_ihc_B1_stall_region thebb_ihc_B1_stall_region (
        ...
        .out_iowr_bl_s3_0_o_fifodata(bb_ihc_B1_stall_region_out_iowr_bl_s3_0_o_fifodata),
        .out_iowr_bl_s3_0_o_fifovalid(bb_ihc_B1_stall_region_out_iowr_bl_s3_0_o_fifovalid),
        .out_iowr_bl_s3_1_o_fifodata(bb_ihc_B1_stall_region_out_iowr_bl_s3_1_o_fifodata),
        .out_iowr_bl_s3_1_o_fifovalid(bb_ihc_B1_stall_region_out_iowr_bl_s3_1_o_fifovalid),
    ...
    // out_iord_bl_s2_0_o_fifoalmost_full(GPOUT,22)
    assign out_iord_bl_s2_0_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s2_0_o_fifoalmost_full;

    // out_iord_bl_s2_0_o_fifoready(GPOUT,23)
    assign out_iord_bl_s2_0_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s2_0_o_fifoready;

    // out_iord_bl_s2_1_o_fifoalmost_full(GPOUT,24)
    assign out_iord_bl_s2_1_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s2_1_o_fifoalmost_full;

    // out_iord_bl_s2_1_o_fifoready(GPOUT,25)
    assign out_iord_bl_s2_1_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s2_1_o_fifoready;

    // out_iord_bl_s2_2_o_fifoalmost_full(GPOUT,26)
    assign out_iord_bl_s2_2_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s2_2_o_fifoalmost_full;

    // out_iord_bl_s2_2_o_fifoready(GPOUT,27)
    assign out_iord_bl_s2_2_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s2_2_o_fifoready;

    // out_iord_bl_s2_3_o_fifoalmost_full(GPOUT,28)
    assign out_iord_bl_s2_3_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s2_3_o_fifoalmost_full;

    // out_iord_bl_s2_3_o_fifoready(GPOUT,29)
    assign out_iord_bl_s2_3_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s2_3_o_fifoready;

    // out_iowr_bl_s3_0_o_fifodata(GPOUT,30)
    assign out_iowr_bl_s3_0_o_fifodata = bb_ihc_B1_stall_region_out_iowr_bl_s3_0_o_fifodata;

    // out_iowr_bl_s3_0_o_fifovalid(GPOUT,31)
    assign out_iowr_bl_s3_0_o_fifovalid = bb_ihc_B1_stall_region_out_iowr_bl_s3_0_o_fifovalid;

    // out_iowr_bl_s3_1_o_fifodata(GPOUT,32)
    assign out_iowr_bl_s3_1_o_fifodata = bb_ihc_B1_stall_region_out_iowr_bl_s3_1_o_fifodata;

    // out_iowr_bl_s3_1_o_fifovalid(GPOUT,33)
    assign out_iowr_bl_s3_1_o_fifovalid = bb_ihc_B1_stall_region_out_iowr_bl_s3_1_o_fifovalid;
