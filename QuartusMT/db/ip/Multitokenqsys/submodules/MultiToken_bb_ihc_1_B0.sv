...
module MultiToken_bb_ihc_1_B0 (
    ...
    MultiToken_ihc_1_B0_merge theihc_1_B0_merge (
    ...
    MultiToken_ihc_1_B0_branch theihc_1_B0_branch (
    ...
    MultiToken_bb_ihc_1_B0_stall_region thebb_ihc_1_B0_stall_region (
