...
module MultiToken_function_wrapper (
    ...
    input wire [0:0] avst_iowr_bl_s3_0_almostfull,
    input wire [0:0] avst_iowr_bl_s3_1_almostfull,
    input wire [0:0] avst_iowr_nb_return_MultiToken_almostfull,
    input wire [0:0] avst_iowr_s3_almost_full,
    input wire [0:0] avst_iowr_s3_ready,
    ...
    output wire [31:0] avst_iowr_s3_data,
    output wire [0:0] avst_iowr_s3_valid,
    input wire clock,
    input wire resetn
    );
    ...
    wire [31:0] ihc_function_out_iowr_s3_o_fifodata;
    wire [0:0] ihc_function_out_iowr_s3_o_fifovalid;
    ...
    wire [0:0] iowr_s3_fifo_inst_out_stream_in_ready;
    wire [31:0] iowr_s3_fifo_inst_out_stream_out_data;
    wire [0:0] iowr_s3_fifo_inst_out_stream_out_valid;


    // GND(CONSTANT,0)
    assign GND_q = $unsigned(1'b0);

    // iowr_s3_fifo_inst(BLACKBOX,30)
    MultiToken_iowr_s3_fifo_inst theiowr_s3_fifo_inst (
        .in_stream_in_data(ihc_function_out_iowr_s3_o_fifodata),
        .in_stream_in_valid(ihc_function_out_iowr_s3_o_fifovalid),
        .in_stream_out_almost_full(avst_iowr_s3_almost_full),
        .in_stream_out_ready(avst_iowr_s3_ready),
        .out_stream_in_ready(iowr_s3_fifo_inst_out_stream_in_ready),
        .out_stream_out_data(iowr_s3_fifo_inst_out_stream_out_data),
        .out_stream_out_valid(iowr_s3_fifo_inst_out_stream_out_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // iowr_s2_fifo_inst(BLACKBOX,29)
    ...
    MultiToken_ihc_function theihc_function (
        ...
        .in_iowr_s3_i_fifoready(iowr_s3_fifo_inst_out_stream_in_ready),
        .in_stall_in(GND_q),
        .in_valid_in(VCC_q),
        ...
        .out_iowr_s3_o_fifodata(ihc_function_out_iowr_s3_o_fifodata),
        .out_iowr_s3_o_fifovalid(ihc_function_out_iowr_s3_o_fifovalid),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // iord_bl_s0_fifo_inst(BLACKBOX,28)
    MultiToken_iord_bl_s0_fifo_inst theiord_bl_s0_fifo_inst (
