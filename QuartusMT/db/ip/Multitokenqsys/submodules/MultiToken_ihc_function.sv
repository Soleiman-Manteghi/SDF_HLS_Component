...
module MultiToken_ihc_function (
    ...
    input wire [0:0] in_iowr_s3_i_fifoready,
    ...
    output wire [31:0] out_iowr_s3_o_fifodata,
    output wire [0:0] out_iowr_s3_o_fifovalid,
    ...
    wire [31:0] arbiter_iowr_s3_out_o_fifodata;
    wire [0:0] arbiter_iowr_s3_out_o_fifovalid;
    wire [0:0] arbiter_iowr_s3_out_ready_out0;
    wire [0:0] arbiter_iowr_s3_out_ready_out1;
    ...
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_0_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_0_o_fifoready;
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_1_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_1_o_fifoready;
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_2_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_2_o_fifoready;
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_3_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s2_3_o_fifoready;
    wire [31:0] bb_ihc_B1_out_iowr_bl_s3_0_o_fifodata;
    wire [0:0] bb_ihc_B1_out_iowr_bl_s3_0_o_fifovalid;
    wire [31:0] bb_ihc_B1_out_iowr_bl_s3_1_o_fifodata;
    wire [0:0] bb_ihc_B1_out_iowr_bl_s3_1_o_fifovalid;
    ...
    // arbiter_iowr_s3(BLACKBOX,3)
    MultiToken_arbiter_iowr_s3 thearbiter_iowr_s3 (
        .in_data_in0(bb_ihc_B1_out_iowr_bl_s3_0_o_fifodata),
        .in_data_in1(bb_ihc_B1_out_iowr_bl_s3_1_o_fifodata),
        .in_i_fifoready(in_iowr_s3_i_fifoready),
        .in_valid_in0(bb_ihc_B1_out_iowr_bl_s3_0_o_fifovalid),
        .in_valid_in1(bb_ihc_B1_out_iowr_bl_s3_1_o_fifovalid),
        .out_o_fifodata(arbiter_iowr_s3_out_o_fifodata),
        .out_o_fifovalid(arbiter_iowr_s3_out_o_fifovalid),
        .out_ready_out0(arbiter_iowr_s3_out_ready_out0),
        .out_ready_out1(arbiter_iowr_s3_out_ready_out1),
        .clock(clock),
        .resetn(resetn)
    );

    // arbiter_iord_s2(BLACKBOX,2)
    MultiToken_arbiter_iord_s2 thearbiter_iord_s2 (
        .in_almost_full_in0(bb_ihc_B1_out_iord_bl_s2_0_o_fifoalmost_full),
        .in_almost_full_in1(bb_ihc_B1_out_iord_bl_s2_1_o_fifoalmost_full),
        .in_almost_full_in2(bb_ihc_B1_out_iord_bl_s2_2_o_fifoalmost_full),
        .in_almost_full_in3(bb_ihc_B1_out_iord_bl_s2_3_o_fifoalmost_full),
        .in_i_fifodata(in_iord_s2_i_fifodata),
        .in_i_fifovalid(in_iord_s2_i_fifovalid),
        .in_ready_in0(bb_ihc_B1_out_iord_bl_s2_0_o_fifoready),
        .in_ready_in1(bb_ihc_B1_out_iord_bl_s2_1_o_fifoready),
        .in_ready_in2(bb_ihc_B1_out_iord_bl_s2_2_o_fifoready),
        .in_ready_in3(bb_ihc_B1_out_iord_bl_s2_3_o_fifoready),
    ...
    MultiToken_bb_ihc_B1 thebb_ihc_B1 (
        ...
        .in_iowr_bl_s3_0_i_fifoready(arbiter_iowr_s3_out_ready_out0),
        .in_iowr_bl_s3_1_i_fifoready(arbiter_iowr_s3_out_ready_out1),
        ...
        .out_iord_bl_s2_0_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s2_0_o_fifoalmost_full),
        .out_iord_bl_s2_0_o_fifoready(bb_ihc_B1_out_iord_bl_s2_0_o_fifoready),
        .out_iord_bl_s2_1_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s2_1_o_fifoalmost_full),
        .out_iord_bl_s2_1_o_fifoready(bb_ihc_B1_out_iord_bl_s2_1_o_fifoready),
        .out_iord_bl_s2_2_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s2_2_o_fifoalmost_full),
        .out_iord_bl_s2_2_o_fifoready(bb_ihc_B1_out_iord_bl_s2_2_o_fifoready),
        .out_iord_bl_s2_3_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s2_3_o_fifoalmost_full),
        .out_iord_bl_s2_3_o_fifoready(bb_ihc_B1_out_iord_bl_s2_3_o_fifoready),
        .out_iowr_bl_s3_0_o_fifodata(bb_ihc_B1_out_iowr_bl_s3_0_o_fifodata),
        .out_iowr_bl_s3_0_o_fifovalid(bb_ihc_B1_out_iowr_bl_s3_0_o_fifovalid),
        .out_iowr_bl_s3_1_o_fifodata(bb_ihc_B1_out_iowr_bl_s3_1_o_fifodata),
        .out_iowr_bl_s3_1_o_fifovalid(bb_ihc_B1_out_iowr_bl_s3_1_o_fifovalid),
    ...
    // bb_ihc_B1_sr_1_aunroll_x(BLACKBOX,35)
    ...
    // out_iord_bl_call_ihc_o_fifoalmost_full(GPOUT,27)
    assign out_iord_bl_call_ihc_o_fifoalmost_full = bb_ihc_B0_out_iord_bl_call_ihc_o_fifoalmost_full;

    // out_iord_bl_call_ihc_o_fifoready(GPOUT,28)
    assign out_iord_bl_call_ihc_o_fifoready = bb_ihc_B0_out_iord_bl_call_ihc_o_fifoready;

    // out_iord_s2_o_fifoalmost_full(GPOUT,29)
    assign out_iord_s2_o_fifoalmost_full = arbiter_iord_s2_out_o_fifoalmost_full;

    // out_iord_s2_o_fifoready(GPOUT,30)
    assign out_iord_s2_o_fifoready = arbiter_iord_s2_out_o_fifoready;

    // out_iowr_s3_o_fifodata(GPOUT,31)
    assign out_iowr_s3_o_fifodata = arbiter_iowr_s3_out_o_fifodata;

    // out_iowr_s3_o_fifovalid(GPOUT,32)
    assign out_iowr_s3_o_fifovalid = arbiter_iowr_s3_out_o_fifovalid;
