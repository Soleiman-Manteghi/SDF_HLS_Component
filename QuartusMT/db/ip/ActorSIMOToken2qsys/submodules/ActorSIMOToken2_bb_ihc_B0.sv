...
module ActorSIMOToken2_bb_ihc_B0 (
    ...
    ActorSIMOToken2_ihc_B0_merge theihc_B0_merge (
    ...
    ActorSIMOToken2_ihc_B0_branch theihc_B0_branch (
    ...
    ActorSIMOToken2_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
