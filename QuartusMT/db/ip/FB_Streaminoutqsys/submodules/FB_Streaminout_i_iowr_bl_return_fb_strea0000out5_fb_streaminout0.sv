...
// SystemVerilog created from i_iowr_bl_return_fb_streaminout_unnamed_fb_streaminout5_fb_streaminout0
...
module FB_Streaminout_i_iowr_bl_return_fb_strea0000out5_fb_streaminout0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_FB_Streaminout_i_fifoready;
    ...
    assign out_iowr_bl_return_FB_Streaminout_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_FB_Streaminout_o_fifovalid = iowr_o_fifovalid;
