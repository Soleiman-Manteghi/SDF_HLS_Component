...
// SystemVerilog created from i_iowr_bl_b_unnamed_fb_streaminout4_fb_streaminout0
...
module FB_Streaminout_i_iowr_bl_b_unnamed_fb_st0000out4_fb_streaminout0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_b_i_fifoready;
    ...
    assign out_iowr_bl_b_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_b_o_fifovalid = iowr_o_fifovalid;
