...
// SystemVerilog created from i_iowr_nb_return_sdf_hls_component_unnamed_sdf_hls_component6_sdf_hls_component0
...
module SDF_HLS_component_i_iowr_nb_return_sdf_h00006_sdf_hls_component0 (
    ...
    assign out_iowr_nb_return_SDF_HLS_component_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_SDF_HLS_component_o_fifovalid = iowr_nb_o_fifovalid;
