...
module SDF_HLS_component_ihc_function (
    ...
    SDF_HLS_component_i_llvm_fpga_pipeline_k0000oing_ihc2_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo (
    ...
    SDF_HLS_component_i_llvm_fpga_pipeline_keep_going_ihc2_sr thei_llvm_fpga_pipeline_keep_going_ihc2_sr (
        .in_i_data(GND_q),
    ...
    SDF_HLS_component_arbiter_iowr_s4 thearbiter_iowr_s4 (
    ...
    SDF_HLS_component_arbiter_iord_s1 thearbiter_iord_s1 (
    ...
    SDF_HLS_component_bb_ihc_B0 thebb_ihc_B0 (
    ...
    SDF_HLS_component_bb_ihc_B1_sr_1 thebb_ihc_B1_sr_1_aunroll_x (
