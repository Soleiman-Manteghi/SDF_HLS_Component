...
module ActorSIMOToken6_ihc_1_function (
    ...
    ActorSIMOToken6_i_llvm_fpga_pipeline_kee0000ng_ihc_12_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc_12_valid_fifo (
    ...
    ActorSIMOToken6_i_llvm_fpga_pipeline_keep_going_ihc_12_sr thei_llvm_fpga_pipeline_keep_going_ihc_12_sr (
        .in_i_data(GND_q),
    ...
    ActorSIMOToken6_arbiter_iord_s2 thearbiter_iord_s2 (
    ...
    ActorSIMOToken6_bb_ihc_1_B1 thebb_ihc_1_B1 (
        .in_forked_0(GND_q),
    ...
    ActorSIMOToken6_bb_ihc_1_B0 thebb_ihc_1_B0 (
    ...
    ActorSIMOToken6_bb_ihc_1_B1_sr_1 thebb_ihc_1_B1_sr_1_aunroll_x (
