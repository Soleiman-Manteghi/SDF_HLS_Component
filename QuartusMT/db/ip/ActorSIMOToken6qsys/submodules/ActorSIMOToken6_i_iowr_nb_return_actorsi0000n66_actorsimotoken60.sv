...
// SystemVerilog created from i_iowr_nb_return_actorsimotoken6_unnamed_actorsimotoken66_actorsimotoken60
...
module ActorSIMOToken6_i_iowr_nb_return_actorsi0000n66_actorsimotoken60 (
    ...
    assign out_iowr_nb_return_ActorSIMOToken6_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_ActorSIMOToken6_o_fifovalid = iowr_nb_o_fifovalid;
