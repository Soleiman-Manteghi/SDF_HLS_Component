...
module ActorSIMOToken6_ihc_2_function (
    ...
    ActorSIMOToken6_i_llvm_fpga_pipeline_kee0000ng_ihc_22_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc_22_valid_fifo (
    ...
    ActorSIMOToken6_i_llvm_fpga_pipeline_keep_going_ihc_22_sr thei_llvm_fpga_pipeline_keep_going_ihc_22_sr (
        .in_i_data(GND_q),
    ...
    ActorSIMOToken6_arbiter_iowr_s2 thearbiter_iowr_s2 (
    ...
    ActorSIMOToken6_arbiter_iowr_s1 thearbiter_iowr_s1 (
    ...
    ActorSIMOToken6_bb_ihc_2_B1 thebb_ihc_2_B1 (
        .in_forked_0(GND_q),
    ...
    ActorSIMOToken6_bb_ihc_2_B0 thebb_ihc_2_B0 (
    ...
    ActorSIMOToken6_bb_ihc_2_B1_sr_1 thebb_ihc_2_B1_sr_1_aunroll_x (
