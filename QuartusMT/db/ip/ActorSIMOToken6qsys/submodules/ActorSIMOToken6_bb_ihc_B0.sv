...
module ActorSIMOToken6_bb_ihc_B0 (
    ...
    ActorSIMOToken6_ihc_B0_merge theihc_B0_merge (
    ...
    ActorSIMOToken6_ihc_B0_branch theihc_B0_branch (
    ...
    ActorSIMOToken6_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
