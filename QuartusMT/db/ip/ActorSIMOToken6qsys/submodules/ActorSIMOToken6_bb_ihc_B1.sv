...
module ActorSIMOToken6_bb_ihc_B1 (
    ...
    ActorSIMOToken6_ihc_B1_branch theihc_B1_branch (
    ...
    ActorSIMOToken6_ihc_B1_merge theihc_B1_merge (
    ...
    ActorSIMOToken6_bb_ihc_B1_stall_region thebb_ihc_B1_stall_region (
