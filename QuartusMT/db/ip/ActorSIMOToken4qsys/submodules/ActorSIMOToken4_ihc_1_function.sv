...
module ActorSIMOToken4_ihc_1_function (
    ...
    wire [0:0] bb_ihc_1_B1_out_iord_bl_s0_o_fifoalmost_full;
    wire [0:0] bb_ihc_1_B1_out_iord_bl_s0_o_fifoready;
    wire [31:0] bb_ihc_1_B1_out_iowr_bl_s1_0_o_fifodata;
    wire [0:0] bb_ihc_1_B1_out_iowr_bl_s1_0_o_fifovalid;
    wire [31:0] bb_ihc_1_B1_out_iowr_bl_s1_1_o_fifodata;
    wire [0:0] bb_ihc_1_B1_out_iowr_bl_s1_1_o_fifovalid;
    wire [31:0] bb_ihc_1_B1_out_iowr_bl_s2_0_o_fifodata;
    wire [0:0] bb_ihc_1_B1_out_iowr_bl_s2_0_o_fifovalid;
    wire [31:0] bb_ihc_1_B1_out_iowr_bl_s2_1_o_fifodata;
    wire [0:0] bb_ihc_1_B1_out_iowr_bl_s2_1_o_fifovalid;
    wire [31:0] bb_ihc_1_B1_out_iowr_bl_s2_2_o_fifodata;
    wire [0:0] bb_ihc_1_B1_out_iowr_bl_s2_2_o_fifovalid;
    wire [31:0] bb_ihc_1_B1_out_iowr_bl_s2_3_o_fifodata;
    wire [0:0] bb_ihc_1_B1_out_iowr_bl_s2_3_o_fifovalid;
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc_12_valid_fifo(BLACKBOX,15)
    ActorSIMOToken4_i_llvm_fpga_pipeline_kee0000ng_ihc_12_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc_12_valid_fifo (
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc_12_sr(BLACKBOX,14)
    ActorSIMOToken4_i_llvm_fpga_pipeline_keep_going_ihc_12_sr thei_llvm_fpga_pipeline_keep_going_ihc_12_sr (
        .in_i_data(GND_q),
    ...
    ActorSIMOToken4_arbiter_iowr_s2 thearbiter_iowr_s2 (
        .in_data_in0(bb_ihc_1_B1_out_iowr_bl_s2_0_o_fifodata),
        .in_data_in1(bb_ihc_1_B1_out_iowr_bl_s2_1_o_fifodata),
        .in_data_in2(bb_ihc_1_B1_out_iowr_bl_s2_2_o_fifodata),
        .in_data_in3(bb_ihc_1_B1_out_iowr_bl_s2_3_o_fifodata),
        .in_i_fifoready(in_iowr_s2_i_fifoready),
        .in_valid_in0(bb_ihc_1_B1_out_iowr_bl_s2_0_o_fifovalid),
        .in_valid_in1(bb_ihc_1_B1_out_iowr_bl_s2_1_o_fifovalid),
        .in_valid_in2(bb_ihc_1_B1_out_iowr_bl_s2_2_o_fifovalid),
        .in_valid_in3(bb_ihc_1_B1_out_iowr_bl_s2_3_o_fifovalid),
    ...
    ActorSIMOToken4_arbiter_iowr_s1 thearbiter_iowr_s1 (
        .in_data_in0(bb_ihc_1_B1_out_iowr_bl_s1_0_o_fifodata),
        .in_data_in1(bb_ihc_1_B1_out_iowr_bl_s1_1_o_fifodata),
        .in_i_fifoready(in_iowr_s1_i_fifoready),
        .in_valid_in0(bb_ihc_1_B1_out_iowr_bl_s1_0_o_fifovalid),
        .in_valid_in1(bb_ihc_1_B1_out_iowr_bl_s1_1_o_fifovalid),
    ...
    // bb_ihc_1_B1(BLACKBOX,5)
    ActorSIMOToken4_bb_ihc_1_B1 thebb_ihc_1_B1 (
        .in_forked_0(GND_q),
        ...
        .out_iord_bl_s0_o_fifoalmost_full(bb_ihc_1_B1_out_iord_bl_s0_o_fifoalmost_full),
        .out_iord_bl_s0_o_fifoready(bb_ihc_1_B1_out_iord_bl_s0_o_fifoready),
        .out_iowr_bl_s1_0_o_fifodata(bb_ihc_1_B1_out_iowr_bl_s1_0_o_fifodata),
        .out_iowr_bl_s1_0_o_fifovalid(bb_ihc_1_B1_out_iowr_bl_s1_0_o_fifovalid),
        .out_iowr_bl_s1_1_o_fifodata(bb_ihc_1_B1_out_iowr_bl_s1_1_o_fifodata),
        .out_iowr_bl_s1_1_o_fifovalid(bb_ihc_1_B1_out_iowr_bl_s1_1_o_fifovalid),
        .out_iowr_bl_s2_0_o_fifodata(bb_ihc_1_B1_out_iowr_bl_s2_0_o_fifodata),
        .out_iowr_bl_s2_0_o_fifovalid(bb_ihc_1_B1_out_iowr_bl_s2_0_o_fifovalid),
        .out_iowr_bl_s2_1_o_fifodata(bb_ihc_1_B1_out_iowr_bl_s2_1_o_fifodata),
        .out_iowr_bl_s2_1_o_fifovalid(bb_ihc_1_B1_out_iowr_bl_s2_1_o_fifovalid),
        .out_iowr_bl_s2_2_o_fifodata(bb_ihc_1_B1_out_iowr_bl_s2_2_o_fifodata),
        .out_iowr_bl_s2_2_o_fifovalid(bb_ihc_1_B1_out_iowr_bl_s2_2_o_fifovalid),
        .out_iowr_bl_s2_3_o_fifodata(bb_ihc_1_B1_out_iowr_bl_s2_3_o_fifodata),
        .out_iowr_bl_s2_3_o_fifovalid(bb_ihc_1_B1_out_iowr_bl_s2_3_o_fifovalid),
    ...
    // bb_ihc_1_B0(BLACKBOX,4)
    ActorSIMOToken4_bb_ihc_1_B0 thebb_ihc_1_B0 (
    ...
    // bb_ihc_1_B1_sr_1_aunroll_x(BLACKBOX,39)
    ActorSIMOToken4_bb_ihc_1_B1_sr_1 thebb_ihc_1_B1_sr_1_aunroll_x (
    ...
    assign out_iord_bl_s0_o_fifoalmost_full = bb_ihc_1_B1_out_iord_bl_s0_o_fifoalmost_full;

    // out_iord_bl_s0_o_fifoready(GPOUT,32)
    assign out_iord_bl_s0_o_fifoready = bb_ihc_1_B1_out_iord_bl_s0_o_fifoready;
