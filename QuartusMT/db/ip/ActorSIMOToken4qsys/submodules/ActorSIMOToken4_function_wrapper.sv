...
// SystemVerilog created from ActorSIMOToken4_function_wrapper
...
module ActorSIMOToken4_function_wrapper (
    input wire [0:0] avst_iord_bl_call_ActorSIMOToken4_data,
    input wire [0:0] avst_iord_bl_call_ActorSIMOToken4_valid,
    ...
    input wire [0:0] avst_iowr_nb_return_ActorSIMOToken4_almostfull,
    input wire [0:0] avst_iowr_s1_almost_full,
    input wire [0:0] avst_iowr_s1_ready,
    input wire [0:0] stall_in,
    input wire [0:0] start,
    input wire [0:0] valid_in,
    output wire [0:0] avst_iord_bl_call_ActorSIMOToken4_almost_full,
    output wire [0:0] avst_iord_bl_call_ActorSIMOToken4_ready,
    output wire [0:0] avst_iord_bl_s0_almost_full,
    output wire [0:0] avst_iord_bl_s0_ready,
    output wire [0:0] avst_iowr_nb_return_ActorSIMOToken4_data,
    output wire [0:0] avst_iowr_nb_return_ActorSIMOToken4_valid,
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [0:0] ActorSIMOToken4_function_out_iord_bl_call_ActorSIMOToken4_o_fifoalmost_full;
    wire [0:0] ActorSIMOToken4_function_out_iord_bl_call_ActorSIMOToken4_o_fifoready;
    wire [0:0] ActorSIMOToken4_function_out_iowr_bl_call_ihc_1_o_fifodata;
    wire [0:0] ActorSIMOToken4_function_out_iowr_bl_call_ihc_1_o_fifovalid;
    wire [0:0] ActorSIMOToken4_function_out_iowr_bl_call_ihc_o_fifodata;
    wire [0:0] ActorSIMOToken4_function_out_iowr_bl_call_ihc_o_fifovalid;
    wire [0:0] ActorSIMOToken4_function_out_iowr_nb_return_ActorSIMOToken4_o_fifodata;
    wire [0:0] ActorSIMOToken4_function_out_iowr_nb_return_ActorSIMOToken4_o_fifovalid;
    ...
    wire [0:0] ihc_function_out_iord_s2_o_fifoalmost_full;
    wire [0:0] ihc_function_out_iord_s2_o_fifoready;
    ...
    // iowr_s2_fifo_inst(BLACKBOX,28)
    ActorSIMOToken4_iowr_s2_fifo_inst theiowr_s2_fifo_inst (
        .in_stream_in_data(ihc_1_function_out_iowr_s2_o_fifodata),
        .in_stream_in_valid(ihc_1_function_out_iowr_s2_o_fifovalid),
        .in_stream_out_almost_full(ihc_function_out_iord_s2_o_fifoalmost_full),
        .in_stream_out_ready(ihc_function_out_iord_s2_o_fifoready),
    ...
    ActorSIMOToken4_ihc_function theihc_function (
        .in_arg_call(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_iord_bl_call_ihc_i_fifodata(ActorSIMOToken4_function_out_iowr_bl_call_ihc_o_fifodata),
        .in_iord_bl_call_ihc_i_fifovalid(ActorSIMOToken4_function_out_iowr_bl_call_ihc_o_fifovalid),
        ...
        .out_iord_s2_o_fifoalmost_full(ihc_function_out_iord_s2_o_fifoalmost_full),
        .out_iord_s2_o_fifoready(ihc_function_out_iord_s2_o_fifoready),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // iowr_s1_fifo_inst(BLACKBOX,27)
    ActorSIMOToken4_iowr_s1_fifo_inst theiowr_s1_fifo_inst (
    ...
    // iord_bl_s0_fifo_inst(BLACKBOX,26)
    ActorSIMOToken4_iord_bl_s0_fifo_inst theiord_bl_s0_fifo_inst (
    ...
    ActorSIMOToken4_ihc_1_function theihc_1_function (
        .in_arg_call(call_const_q),
        .in_arg_s0_global(call_const_q),
        .in_arg_s1_global(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_iord_bl_call_ihc_1_i_fifodata(ActorSIMOToken4_function_out_iowr_bl_call_ihc_1_o_fifodata),
        .in_iord_bl_call_ihc_1_i_fifovalid(ActorSIMOToken4_function_out_iowr_bl_call_ihc_1_o_fifovalid),
    ...
    // ActorSIMOToken4_function(BLACKBOX,2)
    ActorSIMOToken4_function theActorSIMOToken4_function (
        .in_arg_call(call_const_q),
        .in_arg_return(call_const_q),
        .in_iord_bl_call_ActorSIMOToken4_i_fifodata(avst_iord_bl_call_ActorSIMOToken4_data),
        .in_iord_bl_call_ActorSIMOToken4_i_fifovalid(VCC_q),
        ...
        .in_stall_in(GND_q),
        .in_valid_in(VCC_q),
        .out_iord_bl_call_ActorSIMOToken4_o_fifoalmost_full(ActorSIMOToken4_function_out_iord_bl_call_ActorSIMOToken4_o_fifoalmost_full),
        .out_iord_bl_call_ActorSIMOToken4_o_fifoready(ActorSIMOToken4_function_out_iord_bl_call_ActorSIMOToken4_o_fifoready),
        .out_iowr_bl_call_ihc_1_o_fifodata(ActorSIMOToken4_function_out_iowr_bl_call_ihc_1_o_fifodata),
        .out_iowr_bl_call_ihc_1_o_fifovalid(ActorSIMOToken4_function_out_iowr_bl_call_ihc_1_o_fifovalid),
        .out_iowr_bl_call_ihc_o_fifodata(ActorSIMOToken4_function_out_iowr_bl_call_ihc_o_fifodata),
        .out_iowr_bl_call_ihc_o_fifovalid(ActorSIMOToken4_function_out_iowr_bl_call_ihc_o_fifovalid),
        .out_iowr_nb_return_ActorSIMOToken4_o_fifodata(ActorSIMOToken4_function_out_iowr_nb_return_ActorSIMOToken4_o_fifodata),
        .out_iowr_nb_return_ActorSIMOToken4_o_fifovalid(ActorSIMOToken4_function_out_iowr_nb_return_ActorSIMOToken4_o_fifovalid),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // avst_iord_bl_call_ActorSIMOToken4_almost_full(GPOUT,29)
    assign avst_iord_bl_call_ActorSIMOToken4_almost_full = ActorSIMOToken4_function_out_iord_bl_call_ActorSIMOToken4_o_fifoalmost_full;

    // avst_iord_bl_call_ActorSIMOToken4_ready(GPOUT,30)
    assign avst_iord_bl_call_ActorSIMOToken4_ready = ActorSIMOToken4_function_out_iord_bl_call_ActorSIMOToken4_o_fifoready;

    // avst_iord_bl_s0_almost_full(GPOUT,31)
    assign avst_iord_bl_s0_almost_full = ihc_1_function_out_iord_bl_s0_o_fifoalmost_full;

    // avst_iord_bl_s0_ready(GPOUT,32)
    assign avst_iord_bl_s0_ready = iord_bl_s0_fifo_inst_out_stream_in_ready;

    // avst_iowr_nb_return_ActorSIMOToken4_data(GPOUT,33)
    assign avst_iowr_nb_return_ActorSIMOToken4_data = ActorSIMOToken4_function_out_iowr_nb_return_ActorSIMOToken4_o_fifodata;

    // avst_iowr_nb_return_ActorSIMOToken4_valid(GPOUT,34)
    assign avst_iowr_nb_return_ActorSIMOToken4_valid = ActorSIMOToken4_function_out_iowr_nb_return_ActorSIMOToken4_o_fifovalid;

    // avst_iowr_s1_data(GPOUT,35)
    assign avst_iowr_s1_data = iowr_s1_fifo_inst_out_stream_out_data;

    // avst_iowr_s1_valid(GPOUT,36)
