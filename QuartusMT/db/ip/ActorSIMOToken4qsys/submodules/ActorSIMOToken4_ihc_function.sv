...
module ActorSIMOToken4_ihc_function (
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo(BLACKBOX,14)
    ActorSIMOToken4_i_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo (
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc2_sr(BLACKBOX,13)
    ActorSIMOToken4_i_llvm_fpga_pipeline_keep_going_ihc2_sr thei_llvm_fpga_pipeline_keep_going_ihc2_sr (
        .in_i_data(GND_q),
    ...
    ActorSIMOToken4_arbiter_iord_s2 thearbiter_iord_s2 (
    ...
    // bb_ihc_B1(BLACKBOX,4)
    ActorSIMOToken4_bb_ihc_B1 thebb_ihc_B1 (
        .in_forked_0(GND_q),
    ...
    // bb_ihc_B0(BLACKBOX,3)
    ActorSIMOToken4_bb_ihc_B0 thebb_ihc_B0 (
    ...
    // bb_ihc_B1_sr_1_aunroll_x(BLACKBOX,30)
    ActorSIMOToken4_bb_ihc_B1_sr_1 thebb_ihc_B1_sr_1_aunroll_x (
