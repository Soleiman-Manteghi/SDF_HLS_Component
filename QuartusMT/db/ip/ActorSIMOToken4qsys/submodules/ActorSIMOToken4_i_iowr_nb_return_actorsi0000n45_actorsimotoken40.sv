...
// SystemVerilog created from i_iowr_nb_return_actorsimotoken4_unnamed_actorsimotoken45_actorsimotoken40
...
module ActorSIMOToken4_i_iowr_nb_return_actorsi0000n45_actorsimotoken40 (
    ...
    assign out_iowr_nb_return_ActorSIMOToken4_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_ActorSIMOToken4_o_fifovalid = iowr_nb_o_fifovalid;
