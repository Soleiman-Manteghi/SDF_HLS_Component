...
module ActorSIMOToken4_bb_ihc_B0 (
    ...
    ActorSIMOToken4_ihc_B0_merge theihc_B0_merge (
    ...
    ActorSIMOToken4_ihc_B0_branch theihc_B0_branch (
    ...
    ActorSIMOToken4_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
