...
module MultiToken_ihc_2_function (
    ...
    input wire [31:0] in_iord_s0_i_fifodata,
    input wire [0:0] in_iord_s0_i_fifovalid,
    ...
    output wire [0:0] out_iord_s0_o_fifoalmost_full,
    output wire [0:0] out_iord_s0_o_fifoready,
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [31:0] arbiter_iord_s0_out_data_out0;
    wire [31:0] arbiter_iord_s0_out_data_out1;
    wire [0:0] arbiter_iord_s0_out_o_fifoalmost_full;
    wire [0:0] arbiter_iord_s0_out_o_fifoready;
    wire [0:0] arbiter_iord_s0_out_valid_out0;
    wire [0:0] arbiter_iord_s0_out_valid_out1;
    ...
    wire [0:0] arbiter_iowr_s1_out_ready_out3;
    ...
    wire [0:0] arbiter_iowr_s2_out_ready_out6;
    wire [0:0] arbiter_iowr_s2_out_ready_out7;
    ...
    wire [0:0] bb_ihc_2_B1_out_iord_bl_s0_0_o_fifoalmost_full;
    wire [0:0] bb_ihc_2_B1_out_iord_bl_s0_0_o_fifoready;
    wire [0:0] bb_ihc_2_B1_out_iord_bl_s0_1_o_fifoalmost_full;
    wire [0:0] bb_ihc_2_B1_out_iord_bl_s0_1_o_fifoready;
    ...
    wire [31:0] bb_ihc_2_B1_out_iowr_bl_s1_3_o_fifodata;
    wire [0:0] bb_ihc_2_B1_out_iowr_bl_s1_3_o_fifovalid;
    ...
    wire [31:0] bb_ihc_2_B1_out_iowr_bl_s2_6_o_fifodata;
    wire [0:0] bb_ihc_2_B1_out_iowr_bl_s2_6_o_fifovalid;
    wire [31:0] bb_ihc_2_B1_out_iowr_bl_s2_7_o_fifodata;
    wire [0:0] bb_ihc_2_B1_out_iowr_bl_s2_7_o_fifovalid;
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc_22_valid_fifo(BLACKBOX,16)
    MultiToken_i_llvm_fpga_pipeline_keep_going_ihc_22_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc_22_valid_fifo (
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc_22_sr(BLACKBOX,15)
    MultiToken_i_llvm_fpga_pipeline_keep_going_ihc_22_sr thei_llvm_fpga_pipeline_keep_going_ihc_22_sr (
        .in_i_data(GND_q),
    ...
    MultiToken_arbiter_iowr_s2 thearbiter_iowr_s2 (
        ...
        .in_data_in6(bb_ihc_2_B1_out_iowr_bl_s2_6_o_fifodata),
        .in_data_in7(bb_ihc_2_B1_out_iowr_bl_s2_7_o_fifodata),
        ...
        .in_valid_in6(bb_ihc_2_B1_out_iowr_bl_s2_6_o_fifovalid),
        .in_valid_in7(bb_ihc_2_B1_out_iowr_bl_s2_7_o_fifovalid),
        ...
        .out_ready_out6(arbiter_iowr_s2_out_ready_out6),
        .out_ready_out7(arbiter_iowr_s2_out_ready_out7),
        .clock(clock),
        .resetn(resetn)
    );

    // arbiter_iowr_s1(BLACKBOX,3)
    MultiToken_arbiter_iowr_s1 thearbiter_iowr_s1 (
        ...
        .in_data_in3(bb_ihc_2_B1_out_iowr_bl_s1_3_o_fifodata),
        ...
        .in_valid_in3(bb_ihc_2_B1_out_iowr_bl_s1_3_o_fifovalid),
        ...
        .out_ready_out3(arbiter_iowr_s1_out_ready_out3),
        .clock(clock),
        .resetn(resetn)
    );

    // arbiter_iord_s0(BLACKBOX,2)
    MultiToken_arbiter_iord_s0 thearbiter_iord_s0 (
        .in_almost_full_in0(bb_ihc_2_B1_out_iord_bl_s0_0_o_fifoalmost_full),
        .in_almost_full_in1(bb_ihc_2_B1_out_iord_bl_s0_1_o_fifoalmost_full),
        .in_i_fifodata(in_iord_s0_i_fifodata),
        .in_i_fifovalid(in_iord_s0_i_fifovalid),
        .in_ready_in0(bb_ihc_2_B1_out_iord_bl_s0_0_o_fifoready),
        .in_ready_in1(bb_ihc_2_B1_out_iord_bl_s0_1_o_fifoready),
        .out_data_out0(arbiter_iord_s0_out_data_out0),
        .out_data_out1(arbiter_iord_s0_out_data_out1),
        .out_o_fifoalmost_full(arbiter_iord_s0_out_o_fifoalmost_full),
        .out_o_fifoready(arbiter_iord_s0_out_o_fifoready),
        .out_valid_out0(arbiter_iord_s0_out_valid_out0),
        .out_valid_out1(arbiter_iord_s0_out_valid_out1),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_ihc_2_B1(BLACKBOX,6)
    MultiToken_bb_ihc_2_B1 thebb_ihc_2_B1 (
        .in_forked_0(GND_q),
        .in_forked_1(bb_ihc_2_B1_sr_1_aunroll_x_out_o_data_0_tpl),
        .in_iord_bl_s0_0_i_fifodata(arbiter_iord_s0_out_data_out0),
        .in_iord_bl_s0_0_i_fifovalid(arbiter_iord_s0_out_valid_out0),
        .in_iord_bl_s0_1_i_fifodata(arbiter_iord_s0_out_data_out1),
        .in_iord_bl_s0_1_i_fifovalid(arbiter_iord_s0_out_valid_out1),
        ...
        .in_iowr_bl_s1_3_i_fifoready(arbiter_iowr_s1_out_ready_out3),
        ...
        .in_iowr_bl_s2_6_i_fifoready(arbiter_iowr_s2_out_ready_out6),
        .in_iowr_bl_s2_7_i_fifoready(arbiter_iowr_s2_out_ready_out7),
        ...
        .out_iord_bl_s0_0_o_fifoalmost_full(bb_ihc_2_B1_out_iord_bl_s0_0_o_fifoalmost_full),
        .out_iord_bl_s0_0_o_fifoready(bb_ihc_2_B1_out_iord_bl_s0_0_o_fifoready),
        .out_iord_bl_s0_1_o_fifoalmost_full(bb_ihc_2_B1_out_iord_bl_s0_1_o_fifoalmost_full),
        .out_iord_bl_s0_1_o_fifoready(bb_ihc_2_B1_out_iord_bl_s0_1_o_fifoready),
        ...
        .out_iowr_bl_s1_3_o_fifodata(bb_ihc_2_B1_out_iowr_bl_s1_3_o_fifodata),
        .out_iowr_bl_s1_3_o_fifovalid(bb_ihc_2_B1_out_iowr_bl_s1_3_o_fifovalid),
        ...
        .out_iowr_bl_s2_6_o_fifodata(bb_ihc_2_B1_out_iowr_bl_s2_6_o_fifodata),
        .out_iowr_bl_s2_6_o_fifovalid(bb_ihc_2_B1_out_iowr_bl_s2_6_o_fifovalid),
        .out_iowr_bl_s2_7_o_fifodata(bb_ihc_2_B1_out_iowr_bl_s2_7_o_fifodata),
        .out_iowr_bl_s2_7_o_fifovalid(bb_ihc_2_B1_out_iowr_bl_s2_7_o_fifovalid),
    ...
    // bb_ihc_2_B0(BLACKBOX,5)
    MultiToken_bb_ihc_2_B0 thebb_ihc_2_B0 (
    ...
    // bb_ihc_2_B1_sr_1_aunroll_x(BLACKBOX,40)
    MultiToken_bb_ihc_2_B1_sr_1 thebb_ihc_2_B1_sr_1_aunroll_x (
    ...
    // out_iord_bl_call_ihc_2_o_fifoalmost_full(GPOUT,30)
    assign out_iord_bl_call_ihc_2_o_fifoalmost_full = bb_ihc_2_B0_out_iord_bl_call_ihc_2_o_fifoalmost_full;

    // out_iord_bl_call_ihc_2_o_fifoready(GPOUT,31)
    assign out_iord_bl_call_ihc_2_o_fifoready = bb_ihc_2_B0_out_iord_bl_call_ihc_2_o_fifoready;

    // out_iord_s0_o_fifoalmost_full(GPOUT,32)
    assign out_iord_s0_o_fifoalmost_full = arbiter_iord_s0_out_o_fifoalmost_full;

    // out_iord_s0_o_fifoready(GPOUT,33)
    assign out_iord_s0_o_fifoready = arbiter_iord_s0_out_o_fifoready;

    // out_iowr_s1_o_fifodata(GPOUT,34)
    assign out_iowr_s1_o_fifodata = arbiter_iowr_s1_out_o_fifodata;

    // out_iowr_s1_o_fifovalid(GPOUT,35)
    assign out_iowr_s1_o_fifovalid = arbiter_iowr_s1_out_o_fifovalid;

    // out_iowr_s2_o_fifodata(GPOUT,36)
    assign out_iowr_s2_o_fifodata = arbiter_iowr_s2_out_o_fifodata;

    // out_iowr_s2_o_fifovalid(GPOUT,37)
