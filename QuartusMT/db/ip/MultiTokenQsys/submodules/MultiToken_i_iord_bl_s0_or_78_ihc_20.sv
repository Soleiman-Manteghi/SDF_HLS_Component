...
// SystemVerilog created from i_iord_bl_s0_or_78_ihc_20
...
module MultiToken_i_iord_bl_s0_or_78_ihc_20 (
    ...
    // reg_rsrvd_fix(BLACKBOX,6)@20000000
    // out out_data_out@20000001
    // out out_valid_out@20000001
    MultiToken_dupName_3_reg_26oi0676j686u0qc0pdz thereg_rsrvd_fix (
    ...
    // iord(EXTIFACE,4)
    assign iord_i_fifodata = in_iord_bl_s0_0_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_s0_0_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_s0_0_i_fifodata),
    ...
    assign out_iord_bl_s0_0_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,13)
    assign out_iord_bl_s0_0_o_fifoready = iord_o_fifoready;
