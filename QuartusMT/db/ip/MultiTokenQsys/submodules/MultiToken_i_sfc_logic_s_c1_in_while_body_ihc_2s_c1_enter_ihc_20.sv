...
module MultiToken_i_sfc_logic_s_c1_in_while_body_ihc_2s_c1_enter_ihc_20 (
    ...
    wire [32:0] i_inc17_i_i_ihc_28_a;
    wire [32:0] i_inc17_i_i_ihc_28_b;
    logic [32:0] i_inc17_i_i_ihc_28_o;
    wire [32:0] i_inc17_i_i_ihc_28_q;
    ...
    wire [31:0] bgTrunc_i_inc17_i_i_ihc_28_sel_x_b;
    ...
    reg [31:0] redist3_bgTrunc_i_inc17_i_i_ihc_28_sel_x_b_1_q;
    ...
    // i_inc17_i_i_ihc_28(ADD,13)@11
    assign i_inc17_i_i_ihc_28_a = {1'b0, redist4_i_llvm_fpga_pop_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_s4_e3cnt_static_0_pop3_ihc_22_out_data_out_1_q};
    assign i_inc17_i_i_ihc_28_b = {1'b0, c_i32_118_q};
    assign i_inc17_i_i_ihc_28_o = $unsigned(i_inc17_i_i_ihc_28_a) + $unsigned(i_inc17_i_i_ihc_28_b);
    assign i_inc17_i_i_ihc_28_q = i_inc17_i_i_ihc_28_o[32:0];

    // bgTrunc_i_inc17_i_i_ihc_28_sel_x(BITSELECT,20)@11
    assign bgTrunc_i_inc17_i_i_ihc_28_sel_x_b = i_inc17_i_i_ihc_28_q[31:0];

    // redist3_bgTrunc_i_inc17_i_i_ihc_28_sel_x_b_1(DELAY,33)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist3_bgTrunc_i_inc17_i_i_ihc_28_sel_x_b_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist3_bgTrunc_i_inc17_i_i_ihc_28_sel_x_b_1_q <= $unsigned(bgTrunc_i_inc17_i_i_ihc_28_sel_x_b);
        end
    end

    // i_unnamed_ihc_29(LOGICAL,16)@11 + 1
    ...
    // i_acl_2_ihc_210(MUX,9)@12
    assign i_acl_2_ihc_210_s = i_unnamed_ihc_29_q;
    always @(i_acl_2_ihc_210_s or redist3_bgTrunc_i_inc17_i_i_ihc_28_sel_x_b_1_q or c_i32_118_q)
    begin
        unique case (i_acl_2_ihc_210_s)
            1'b0 : i_acl_2_ihc_210_q = redist3_bgTrunc_i_inc17_i_i_ihc_28_sel_x_b_1_q;
            1'b1 : i_acl_2_ihc_210_q = c_i32_118_q;
            default : i_acl_2_ihc_210_q = 32'b0;
        endcase
    end

    // i_llvm_fpga_push_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_s4_e3cnt_static_0_push3_ihc_211(BLACKBOX,15)@12
    // out out_feedback_out_3@20000000
    // out out_feedback_valid_out_3@20000000
    MultiToken_i_llvm_fpga_push_i32_zz12task0000tatic_0_push3_ihc_20 thei_llvm_fpga_push_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_s4_e3cnt_static_0_push3_ihc_211 (
    ...
    // i_llvm_fpga_pop_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_s4_e3cnt_static_0_pop3_ihc_22(BLACKBOX,14)@10
    // out out_feedback_stall_out_3@20000000
    MultiToken_i_llvm_fpga_pop_i32_zz12task_0000static_0_pop3_ihc_20 thei_llvm_fpga_pop_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_s4_e3cnt_static_0_pop3_ihc_22 (
    ...
    // i_cmp6_i_i_ihc_26(LOGICAL,10)@11
    assign i_cmp6_i_i_ihc_26_q = $unsigned(redist4_i_llvm_fpga_pop_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_s4_e3cnt_static_0_pop3_ihc_22_out_data_out_1_q == c_i32_10017_recast_x_q ? 1'b1 : 1'b0);

    // i_cmp_i_i_xor_ihc_25(LOGICAL,12)@11
    assign i_cmp_i_i_xor_ihc_25_q = i_cmp_i_i_ihc_23_q ^ VCC_q;

    // i_cmp_i_i_ihc_23(LOGICAL,11)@11
    ...
    // sync_out_aunroll_x(GPOUT,24)@11
