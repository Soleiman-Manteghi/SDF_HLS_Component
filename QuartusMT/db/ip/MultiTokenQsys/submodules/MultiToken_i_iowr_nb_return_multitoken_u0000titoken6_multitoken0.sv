...
// SystemVerilog created from i_iowr_nb_return_multitoken_unnamed_multitoken6_multitoken0
...
module MultiToken_i_iowr_nb_return_multitoken_u0000titoken6_multitoken0 (
    ...
    assign out_iowr_nb_return_MultiToken_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_MultiToken_o_fifovalid = iowr_nb_o_fifovalid;
