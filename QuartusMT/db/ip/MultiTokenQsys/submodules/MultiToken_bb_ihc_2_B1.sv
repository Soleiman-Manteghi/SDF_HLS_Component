...
module MultiToken_bb_ihc_2_B1 (
    ...
    wire [0:0] bb_ihc_2_B1_stall_region_out_iord_bl_s0_0_o_fifoalmost_full;
    wire [0:0] bb_ihc_2_B1_stall_region_out_iord_bl_s0_0_o_fifoready;
    wire [0:0] bb_ihc_2_B1_stall_region_out_iord_bl_s0_1_o_fifoalmost_full;
    wire [0:0] bb_ihc_2_B1_stall_region_out_iord_bl_s0_1_o_fifoready;
    ...
    wire [31:0] bb_ihc_2_B1_stall_region_out_iowr_bl_s1_3_o_fifodata;
    wire [0:0] bb_ihc_2_B1_stall_region_out_iowr_bl_s1_3_o_fifovalid;
    ...
    wire [31:0] bb_ihc_2_B1_stall_region_out_iowr_bl_s2_6_o_fifodata;
    wire [0:0] bb_ihc_2_B1_stall_region_out_iowr_bl_s2_6_o_fifovalid;
    wire [31:0] bb_ihc_2_B1_stall_region_out_iowr_bl_s2_7_o_fifodata;
    wire [0:0] bb_ihc_2_B1_stall_region_out_iowr_bl_s2_7_o_fifovalid;
    ...
    MultiToken_ihc_2_B1_branch theihc_2_B1_branch (
    ...
    MultiToken_ihc_2_B1_merge theihc_2_B1_merge (
    ...
    MultiToken_bb_ihc_2_B1_stall_region thebb_ihc_2_B1_stall_region (
        ...
        .out_iord_bl_s0_0_o_fifoalmost_full(bb_ihc_2_B1_stall_region_out_iord_bl_s0_0_o_fifoalmost_full),
        .out_iord_bl_s0_0_o_fifoready(bb_ihc_2_B1_stall_region_out_iord_bl_s0_0_o_fifoready),
        .out_iord_bl_s0_1_o_fifoalmost_full(bb_ihc_2_B1_stall_region_out_iord_bl_s0_1_o_fifoalmost_full),
        .out_iord_bl_s0_1_o_fifoready(bb_ihc_2_B1_stall_region_out_iord_bl_s0_1_o_fifoready),
        ...
        .out_iowr_bl_s1_3_o_fifodata(bb_ihc_2_B1_stall_region_out_iowr_bl_s1_3_o_fifodata),
        .out_iowr_bl_s1_3_o_fifovalid(bb_ihc_2_B1_stall_region_out_iowr_bl_s1_3_o_fifovalid),
        ...
        .out_iowr_bl_s2_6_o_fifodata(bb_ihc_2_B1_stall_region_out_iowr_bl_s2_6_o_fifodata),
        .out_iowr_bl_s2_6_o_fifovalid(bb_ihc_2_B1_stall_region_out_iowr_bl_s2_6_o_fifovalid),
        .out_iowr_bl_s2_7_o_fifodata(bb_ihc_2_B1_stall_region_out_iowr_bl_s2_7_o_fifodata),
        .out_iowr_bl_s2_7_o_fifovalid(bb_ihc_2_B1_stall_region_out_iowr_bl_s2_7_o_fifovalid),
    ...
    // out_iord_bl_s0_0_o_fifoalmost_full(GPOUT,28)
    assign out_iord_bl_s0_0_o_fifoalmost_full = bb_ihc_2_B1_stall_region_out_iord_bl_s0_0_o_fifoalmost_full;

    // out_iord_bl_s0_0_o_fifoready(GPOUT,29)
    assign out_iord_bl_s0_0_o_fifoready = bb_ihc_2_B1_stall_region_out_iord_bl_s0_0_o_fifoready;

    // out_iord_bl_s0_1_o_fifoalmost_full(GPOUT,30)
    assign out_iord_bl_s0_1_o_fifoalmost_full = bb_ihc_2_B1_stall_region_out_iord_bl_s0_1_o_fifoalmost_full;

    // out_iord_bl_s0_1_o_fifoready(GPOUT,31)
    assign out_iord_bl_s0_1_o_fifoready = bb_ihc_2_B1_stall_region_out_iord_bl_s0_1_o_fifoready;

    // out_iowr_bl_s1_0_o_fifodata(GPOUT,32)
    assign out_iowr_bl_s1_0_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_0_o_fifodata;

    // out_iowr_bl_s1_0_o_fifovalid(GPOUT,33)
    assign out_iowr_bl_s1_0_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_0_o_fifovalid;

    // out_iowr_bl_s1_1_o_fifodata(GPOUT,34)
    assign out_iowr_bl_s1_1_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_1_o_fifodata;

    // out_iowr_bl_s1_1_o_fifovalid(GPOUT,35)
    assign out_iowr_bl_s1_1_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_1_o_fifovalid;

    // out_iowr_bl_s1_2_o_fifodata(GPOUT,36)
    assign out_iowr_bl_s1_2_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_2_o_fifodata;

    // out_iowr_bl_s1_2_o_fifovalid(GPOUT,37)
    assign out_iowr_bl_s1_2_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_2_o_fifovalid;

    // out_iowr_bl_s1_3_o_fifodata(GPOUT,38)
    assign out_iowr_bl_s1_3_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_3_o_fifodata;

    // out_iowr_bl_s1_3_o_fifovalid(GPOUT,39)
    assign out_iowr_bl_s1_3_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s1_3_o_fifovalid;

    // out_iowr_bl_s2_0_o_fifodata(GPOUT,40)
    assign out_iowr_bl_s2_0_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_0_o_fifodata;

    // out_iowr_bl_s2_0_o_fifovalid(GPOUT,41)
    assign out_iowr_bl_s2_0_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_0_o_fifovalid;

    // out_iowr_bl_s2_1_o_fifodata(GPOUT,42)
    assign out_iowr_bl_s2_1_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_1_o_fifodata;

    // out_iowr_bl_s2_1_o_fifovalid(GPOUT,43)
    assign out_iowr_bl_s2_1_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_1_o_fifovalid;

    // out_iowr_bl_s2_2_o_fifodata(GPOUT,44)
    assign out_iowr_bl_s2_2_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_2_o_fifodata;

    // out_iowr_bl_s2_2_o_fifovalid(GPOUT,45)
    assign out_iowr_bl_s2_2_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_2_o_fifovalid;

    // out_iowr_bl_s2_3_o_fifodata(GPOUT,46)
    assign out_iowr_bl_s2_3_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_3_o_fifodata;

    // out_iowr_bl_s2_3_o_fifovalid(GPOUT,47)
    assign out_iowr_bl_s2_3_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_3_o_fifovalid;

    // out_iowr_bl_s2_4_o_fifodata(GPOUT,48)
    assign out_iowr_bl_s2_4_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_4_o_fifodata;

    // out_iowr_bl_s2_4_o_fifovalid(GPOUT,49)
    assign out_iowr_bl_s2_4_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_4_o_fifovalid;

    // out_iowr_bl_s2_5_o_fifodata(GPOUT,50)
    assign out_iowr_bl_s2_5_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_5_o_fifodata;

    // out_iowr_bl_s2_5_o_fifovalid(GPOUT,51)
    assign out_iowr_bl_s2_5_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_5_o_fifovalid;

    // out_iowr_bl_s2_6_o_fifodata(GPOUT,52)
    assign out_iowr_bl_s2_6_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_6_o_fifodata;

    // out_iowr_bl_s2_6_o_fifovalid(GPOUT,53)
    assign out_iowr_bl_s2_6_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_6_o_fifovalid;

    // out_iowr_bl_s2_7_o_fifodata(GPOUT,54)
    assign out_iowr_bl_s2_7_o_fifodata = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_7_o_fifodata;

    // out_iowr_bl_s2_7_o_fifovalid(GPOUT,55)
    assign out_iowr_bl_s2_7_o_fifovalid = bb_ihc_2_B1_stall_region_out_iowr_bl_s2_7_o_fifovalid;
