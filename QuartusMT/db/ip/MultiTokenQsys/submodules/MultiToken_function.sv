...
module MultiToken_function (
    ...
    wire [0:0] bb_MultiToken_B0_runOnce_out_iowr_bl_call_ihc_2_o_fifodata;
    wire [0:0] bb_MultiToken_B0_runOnce_out_iowr_bl_call_ihc_2_o_fifovalid;
    ...
    MultiToken_bb_B0_runOnce thebb_MultiToken_B0_runOnce (
        ...
        .out_iowr_bl_call_ihc_2_o_fifodata(bb_MultiToken_B0_runOnce_out_iowr_bl_call_ihc_2_o_fifodata),
        .out_iowr_bl_call_ihc_2_o_fifovalid(bb_MultiToken_B0_runOnce_out_iowr_bl_call_ihc_2_o_fifovalid),
    ...
    // bb_MultiToken_B1_start_sr_1_aunroll_x(BLACKBOX,35)
    ...
    // out_iord_bl_call_MultiToken_o_fifoalmost_full(GPOUT,23)
    ...
    // out_iord_bl_call_MultiToken_o_fifoready(GPOUT,24)
    ...
    assign out_iowr_bl_call_ihc_2_o_fifodata = bb_MultiToken_B0_runOnce_out_iowr_bl_call_ihc_2_o_fifodata;

    // out_iowr_bl_call_ihc_2_o_fifovalid(GPOUT,28)
    assign out_iowr_bl_call_ihc_2_o_fifovalid = bb_MultiToken_B0_runOnce_out_iowr_bl_call_ihc_2_o_fifovalid;
