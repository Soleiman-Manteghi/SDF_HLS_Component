...
// SystemVerilog created from i_iowr_bl_return_task_1_unnamed_task_15_task_10
...
module foo_i_iowr_bl_return_task_1_unnamed_task_15_task_10 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_task_1_i_fifoready;
    ...
    assign out_iowr_bl_return_task_1_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_return_task_1_o_fifovalid = iowr_o_fifovalid;
