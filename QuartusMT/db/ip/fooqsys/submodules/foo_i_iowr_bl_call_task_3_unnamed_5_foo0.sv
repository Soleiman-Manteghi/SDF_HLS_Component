...
// SystemVerilog created from i_iowr_bl_call_task_3_unnamed_foo5_foo0
...
module foo_i_iowr_bl_call_task_3_unnamed_5_foo0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_call_task_3_i_fifoready;
    ...
    assign out_iowr_bl_call_task_3_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_call_task_3_o_fifovalid = iowr_o_fifovalid;
