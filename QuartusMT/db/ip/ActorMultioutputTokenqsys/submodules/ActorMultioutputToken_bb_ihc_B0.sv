...
module ActorMultioutputToken_bb_ihc_B0 (
    ...
    ActorMultioutputToken_ihc_B0_merge theihc_B0_merge (
    ...
    ActorMultioutputToken_ihc_B0_branch theihc_B0_branch (
    ...
    ActorMultioutputToken_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
