...
module ActorMultioutputToken_ihc_function (
    ...
    ActorMultioutputToken_i_llvm_fpga_pipeli0000oing_ihc2_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo (
    ...
    ActorMultioutputToken_i_llvm_fpga_pipeline_keep_going_ihc2_sr thei_llvm_fpga_pipeline_keep_going_ihc2_sr (
        .in_i_data(GND_q),
    ...
    ActorMultioutputToken_arbiter_iowr_s2 thearbiter_iowr_s2 (
    ...
    ActorMultioutputToken_arbiter_iowr_s1 thearbiter_iowr_s1 (
    ...
    ActorMultioutputToken_bb_ihc_B1 thebb_ihc_B1 (
        .in_forked_0(GND_q),
    ...
    ActorMultioutputToken_bb_ihc_B0 thebb_ihc_B0 (
    ...
    ActorMultioutputToken_bb_ihc_B1_sr_1 thebb_ihc_B1_sr_1_aunroll_x (
