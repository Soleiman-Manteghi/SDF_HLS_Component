...
// SystemVerilog created from i_iowr_nb_return_actormultioutputtoken_unnamed_actormultioutputtoken4_actormultioutputtoken0
...
module ActorMultioutputToken_i_iowr_nb_return_a0000tormultioutputtoken0 (
    ...
    assign out_iowr_nb_return_ActorMultioutputToken_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_ActorMultioutputToken_o_fifovalid = iowr_nb_o_fifovalid;
