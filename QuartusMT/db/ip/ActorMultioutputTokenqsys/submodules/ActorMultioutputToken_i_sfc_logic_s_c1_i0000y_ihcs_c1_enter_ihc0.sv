...
module ActorMultioutputToken_i_sfc_logic_s_c1_i0000y_ihcs_c1_enter_ihc0 (
    ...
    wire [31:0] c_i32_1019_recast_x_q;
    ...
    ActorMultioutputToken_i_llvm_fpga_push_i0000_static_0_push3_ihc0 thei_llvm_fpga_push_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_e3cnt_static_0_push3_ihc13 (
    ...
    ActorMultioutputToken_i_llvm_fpga_pop_i30000t_static_0_pop3_ihc0 thei_llvm_fpga_pop_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_e3cnt_static_0_pop3_ihc2 (
    ...
    // c_i32_1019_recast_x(CONSTANT,27)
    assign c_i32_1019_recast_x_q = $unsigned(32'b00000000000000000000000000001010);

    // i_cmp3_i_i_ihc6(LOGICAL,13)@7 + 1
    assign i_cmp3_i_i_ihc6_qi = $unsigned(redist4_i_llvm_fpga_pop_i32_zz12task_initialrn3ihc6streamiijns_6bufferili8eeeeees4_e3cnt_static_0_pop3_ihc2_out_data_out_1_q == c_i32_1019_recast_x_q ? 1'b1 : 1'b0);
