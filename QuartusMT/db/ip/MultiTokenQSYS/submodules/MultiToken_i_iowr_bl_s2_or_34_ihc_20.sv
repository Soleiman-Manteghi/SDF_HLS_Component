...
// SystemVerilog created from i_iowr_bl_s2_or_34_ihc_20
...
module MultiToken_i_iowr_bl_s2_or_34_ihc_20 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_s2_6_i_fifoready;
    ...
    assign out_iowr_bl_s2_6_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,8)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,11)
    assign out_iowr_bl_s2_6_o_fifovalid = iowr_o_fifovalid;

    // dupName_0_sync_out_x(GPOUT,12)@17
