...
module MultiToken_function_wrapper (
    ...
    input wire [31:0] avst_iord_s0_data,
    input wire [0:0] avst_iord_s0_valid,
    ...
    input wire [0:0] avst_iowr_bl_s1_3_almostfull,
    ...
    input wire [0:0] avst_iowr_bl_s2_6_almostfull,
    input wire [0:0] avst_iowr_bl_s2_7_almostfull,
    ...
    output wire [0:0] avst_iord_s0_almost_full,
    output wire [0:0] avst_iord_s0_ready,
    ...
    wire [0:0] MultiToken_function_out_iowr_bl_call_ihc_1_o_fifodata;
    wire [0:0] MultiToken_function_out_iowr_bl_call_ihc_1_o_fifovalid;
    wire [0:0] MultiToken_function_out_iowr_bl_call_ihc_2_o_fifodata;
    wire [0:0] MultiToken_function_out_iowr_bl_call_ihc_2_o_fifovalid;
    ...
    wire [0:0] ihc_2_function_out_iord_s0_o_fifoalmost_full;
    wire [0:0] ihc_2_function_out_iord_s0_o_fifoready;
    ...
    wire [0:0] ihc_function_out_iord_bl_s1_o_fifoalmost_full;
    wire [0:0] ihc_function_out_iord_bl_s1_o_fifoready;
    wire [0:0] ihc_function_out_iord_s3_o_fifoalmost_full;
    wire [0:0] ihc_function_out_iord_s3_o_fifoready;
    wire [31:0] ihc_function_out_iowr_s4_o_fifodata;
    wire [0:0] ihc_function_out_iowr_s4_o_fifovalid;
    wire [0:0] iord_s0_fifo_inst_out_stream_in_ready;
    wire [31:0] iord_s0_fifo_inst_out_stream_out_data;
    wire [0:0] iord_s0_fifo_inst_out_stream_out_valid;
    ...
    // iowr_s4_fifo_inst(BLACKBOX,41)
    MultiToken_iowr_s4_fifo_inst theiowr_s4_fifo_inst (
    ...
    // iowr_bl_s3_fifo_inst(BLACKBOX,38)
    MultiToken_iowr_bl_s3_fifo_inst theiowr_bl_s3_fifo_inst (
        .in_stream_in_data(ihc_1_function_out_iowr_bl_s3_o_fifodata),
        .in_stream_in_valid(ihc_1_function_out_iowr_bl_s3_o_fifovalid),
        .in_stream_out_almost_full(ihc_function_out_iord_s3_o_fifoalmost_full),
        .in_stream_out_ready(ihc_function_out_iord_s3_o_fifoready),
    ...
    MultiToken_iowr_s1_fifo_inst theiowr_s1_fifo_inst (
        ...
        .in_stream_out_almost_full(ihc_function_out_iord_bl_s1_o_fifoalmost_full),
        .in_stream_out_ready(ihc_function_out_iord_bl_s1_o_fifoready),
    ...
    MultiToken_ihc_function theihc_function (
        ...
        .in_iord_bl_s1_i_fifodata(iowr_s1_fifo_inst_out_stream_out_data),
        .in_iord_bl_s1_i_fifovalid(iowr_s1_fifo_inst_out_stream_out_valid),
        .in_iord_s3_i_fifodata(iowr_bl_s3_fifo_inst_out_stream_out_data),
        .in_iord_s3_i_fifovalid(iowr_bl_s3_fifo_inst_out_stream_out_valid),
        ...
        .out_iord_bl_s1_o_fifoalmost_full(ihc_function_out_iord_bl_s1_o_fifoalmost_full),
        .out_iord_bl_s1_o_fifoready(ihc_function_out_iord_bl_s1_o_fifoready),
        .out_iord_s3_o_fifoalmost_full(ihc_function_out_iord_s3_o_fifoalmost_full),
        .out_iord_s3_o_fifoready(ihc_function_out_iord_s3_o_fifoready),
    ...
    // iord_s0_fifo_inst(BLACKBOX,37)
    MultiToken_iord_s0_fifo_inst theiord_s0_fifo_inst (
        .in_stream_in_data(avst_iord_s0_data),
        .in_stream_in_valid(avst_iord_s0_valid),
        .in_stream_out_almost_full(ihc_2_function_out_iord_s0_o_fifoalmost_full),
        .in_stream_out_ready(ihc_2_function_out_iord_s0_o_fifoready),
        .out_stream_in_ready(iord_s0_fifo_inst_out_stream_in_ready),
        .out_stream_out_data(iord_s0_fifo_inst_out_stream_out_data),
        .out_stream_out_valid(iord_s0_fifo_inst_out_stream_out_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // ihc_2_function(BLACKBOX,7)
    MultiToken_ihc_2_function theihc_2_function (
        .in_arg_call(call_const_q),
        .in_arg_s0_global(call_const_q),
        .in_arg_s1_global(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_iord_bl_call_ihc_2_i_fifodata(MultiToken_function_out_iowr_bl_call_ihc_2_o_fifodata),
        .in_iord_bl_call_ihc_2_i_fifovalid(MultiToken_function_out_iowr_bl_call_ihc_2_o_fifovalid),
        .in_iord_s0_i_fifodata(iord_s0_fifo_inst_out_stream_out_data),
        .in_iord_s0_i_fifovalid(iord_s0_fifo_inst_out_stream_out_valid),
        ...
        .out_iord_s0_o_fifoalmost_full(ihc_2_function_out_iord_s0_o_fifoalmost_full),
        .out_iord_s0_o_fifoready(ihc_2_function_out_iord_s0_o_fifoready),
    ...
    MultiToken_ihc_1_function theihc_1_function (
        .in_arg_call(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_arg_s3_global(call_const_q),
        .in_iord_bl_call_ihc_1_i_fifodata(MultiToken_function_out_iowr_bl_call_ihc_1_o_fifodata),
        .in_iord_bl_call_ihc_1_i_fifovalid(MultiToken_function_out_iowr_bl_call_ihc_1_o_fifovalid),
    ...
    MultiToken_function theMultiToken_function (
        ...
        .out_iowr_bl_call_ihc_1_o_fifodata(MultiToken_function_out_iowr_bl_call_ihc_1_o_fifodata),
        .out_iowr_bl_call_ihc_1_o_fifovalid(MultiToken_function_out_iowr_bl_call_ihc_1_o_fifovalid),
        .out_iowr_bl_call_ihc_2_o_fifodata(MultiToken_function_out_iowr_bl_call_ihc_2_o_fifodata),
        .out_iowr_bl_call_ihc_2_o_fifovalid(MultiToken_function_out_iowr_bl_call_ihc_2_o_fifovalid),
