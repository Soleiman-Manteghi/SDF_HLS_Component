...
module MultiToken_bb_ihc_B1 (
    ...
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s1_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s1_o_fifoready;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s3_0_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s3_0_o_fifoready;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s3_1_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s3_1_o_fifoready;
    ...
    MultiToken_ihc_B1_branch theihc_B1_branch (
    ...
    MultiToken_ihc_B1_merge theihc_B1_merge (
    ...
    MultiToken_bb_ihc_B1_stall_region thebb_ihc_B1_stall_region (
        ...
        .out_iord_bl_s1_o_fifoalmost_full(bb_ihc_B1_stall_region_out_iord_bl_s1_o_fifoalmost_full),
        .out_iord_bl_s1_o_fifoready(bb_ihc_B1_stall_region_out_iord_bl_s1_o_fifoready),
        .out_iord_bl_s3_0_o_fifoalmost_full(bb_ihc_B1_stall_region_out_iord_bl_s3_0_o_fifoalmost_full),
        .out_iord_bl_s3_0_o_fifoready(bb_ihc_B1_stall_region_out_iord_bl_s3_0_o_fifoready),
        .out_iord_bl_s3_1_o_fifoalmost_full(bb_ihc_B1_stall_region_out_iord_bl_s3_1_o_fifoalmost_full),
        .out_iord_bl_s3_1_o_fifoready(bb_ihc_B1_stall_region_out_iord_bl_s3_1_o_fifoready),
    ...
    // out_iord_bl_s1_o_fifoalmost_full(GPOUT,20)
    assign out_iord_bl_s1_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s1_o_fifoalmost_full;

    // out_iord_bl_s1_o_fifoready(GPOUT,21)
    assign out_iord_bl_s1_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s1_o_fifoready;

    // out_iord_bl_s3_0_o_fifoalmost_full(GPOUT,22)
    assign out_iord_bl_s3_0_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s3_0_o_fifoalmost_full;

    // out_iord_bl_s3_0_o_fifoready(GPOUT,23)
    assign out_iord_bl_s3_0_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s3_0_o_fifoready;

    // out_iord_bl_s3_1_o_fifoalmost_full(GPOUT,24)
    assign out_iord_bl_s3_1_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s3_1_o_fifoalmost_full;

    // out_iord_bl_s3_1_o_fifoready(GPOUT,25)
    assign out_iord_bl_s3_1_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s3_1_o_fifoready;
