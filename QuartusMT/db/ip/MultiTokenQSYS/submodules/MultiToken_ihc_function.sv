...
module MultiToken_ihc_function (
    ...
    input wire [31:0] in_iord_s3_i_fifodata,
    input wire [0:0] in_iord_s3_i_fifovalid,
    ...
    output wire [0:0] out_iord_s3_o_fifoalmost_full,
    output wire [0:0] out_iord_s3_o_fifoready,
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [31:0] arbiter_iord_s3_out_data_out0;
    wire [31:0] arbiter_iord_s3_out_data_out1;
    wire [0:0] arbiter_iord_s3_out_o_fifoalmost_full;
    wire [0:0] arbiter_iord_s3_out_o_fifoready;
    wire [0:0] arbiter_iord_s3_out_valid_out0;
    wire [0:0] arbiter_iord_s3_out_valid_out1;
    ...
    wire [0:0] bb_ihc_B1_out_iord_bl_s1_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s1_o_fifoready;
    wire [0:0] bb_ihc_B1_out_iord_bl_s3_0_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s3_0_o_fifoready;
    wire [0:0] bb_ihc_B1_out_iord_bl_s3_1_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_out_iord_bl_s3_1_o_fifoready;
    ...
    MultiToken_arbiter_iowr_s4 thearbiter_iowr_s4 (
    ...
    // arbiter_iord_s3(BLACKBOX,2)
    MultiToken_arbiter_iord_s3 thearbiter_iord_s3 (
        .in_almost_full_in0(bb_ihc_B1_out_iord_bl_s3_0_o_fifoalmost_full),
        .in_almost_full_in1(bb_ihc_B1_out_iord_bl_s3_1_o_fifoalmost_full),
        .in_i_fifodata(in_iord_s3_i_fifodata),
        .in_i_fifovalid(in_iord_s3_i_fifovalid),
        .in_ready_in0(bb_ihc_B1_out_iord_bl_s3_0_o_fifoready),
        .in_ready_in1(bb_ihc_B1_out_iord_bl_s3_1_o_fifoready),
        .out_data_out0(arbiter_iord_s3_out_data_out0),
        .out_data_out1(arbiter_iord_s3_out_data_out1),
        .out_o_fifoalmost_full(arbiter_iord_s3_out_o_fifoalmost_full),
        .out_o_fifoready(arbiter_iord_s3_out_o_fifoready),
        .out_valid_out0(arbiter_iord_s3_out_valid_out0),
        .out_valid_out1(arbiter_iord_s3_out_valid_out1),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    MultiToken_bb_ihc_B1 thebb_ihc_B1 (
        ...
        .in_iord_bl_s3_0_i_fifodata(arbiter_iord_s3_out_data_out0),
        .in_iord_bl_s3_0_i_fifovalid(arbiter_iord_s3_out_valid_out0),
        .in_iord_bl_s3_1_i_fifodata(arbiter_iord_s3_out_data_out1),
        .in_iord_bl_s3_1_i_fifovalid(arbiter_iord_s3_out_valid_out1),
        ...
        .out_iord_bl_s1_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s1_o_fifoalmost_full),
        .out_iord_bl_s1_o_fifoready(bb_ihc_B1_out_iord_bl_s1_o_fifoready),
        .out_iord_bl_s3_0_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s3_0_o_fifoalmost_full),
        .out_iord_bl_s3_0_o_fifoready(bb_ihc_B1_out_iord_bl_s3_0_o_fifoready),
        .out_iord_bl_s3_1_o_fifoalmost_full(bb_ihc_B1_out_iord_bl_s3_1_o_fifoalmost_full),
        .out_iord_bl_s3_1_o_fifoready(bb_ihc_B1_out_iord_bl_s3_1_o_fifoready),
    ...
    // out_iord_bl_s1_o_fifoalmost_full(GPOUT,32)
    assign out_iord_bl_s1_o_fifoalmost_full = bb_ihc_B1_out_iord_bl_s1_o_fifoalmost_full;

    // out_iord_bl_s1_o_fifoready(GPOUT,33)
    assign out_iord_bl_s1_o_fifoready = bb_ihc_B1_out_iord_bl_s1_o_fifoready;

    // out_iord_s3_o_fifoalmost_full(GPOUT,34)
    assign out_iord_s3_o_fifoalmost_full = arbiter_iord_s3_out_o_fifoalmost_full;

    // out_iord_s3_o_fifoready(GPOUT,35)
    assign out_iord_s3_o_fifoready = arbiter_iord_s3_out_o_fifoready;
