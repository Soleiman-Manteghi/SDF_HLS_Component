...
module ActorSIMOToken5_ihc_function (
    ...
    ActorSIMOToken5_i_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc1_valid_fifo (
    ...
    ActorSIMOToken5_i_llvm_fpga_pipeline_keep_going_ihc1_sr thei_llvm_fpga_pipeline_keep_going_ihc1_sr (
        .in_i_data(GND_q),
    ...
    ActorSIMOToken5_bb_ihc_B1 thebb_ihc_B1 (
    ...
    ActorSIMOToken5_bb_ihc_B0 thebb_ihc_B0 (
    ...
    ActorSIMOToken5_bb_ihc_B1_sr_1 thebb_ihc_B1_sr_1_aunroll_x (
