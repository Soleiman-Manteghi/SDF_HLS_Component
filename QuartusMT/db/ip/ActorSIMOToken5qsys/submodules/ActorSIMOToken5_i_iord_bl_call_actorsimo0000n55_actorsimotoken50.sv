...
// SystemVerilog created from i_iord_bl_call_actorsimotoken5_unnamed_actorsimotoken55_actorsimotoken50
...
module ActorSIMOToken5_i_iord_bl_call_actorsimo0000n55_actorsimotoken50 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_call_ActorSIMOToken5_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_ActorSIMOToken5_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_ActorSIMOToken5_i_fifodata),
    ...
    assign out_iord_bl_call_ActorSIMOToken5_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,13)
    assign out_iord_bl_call_ActorSIMOToken5_o_fifoready = iord_o_fifoready;
