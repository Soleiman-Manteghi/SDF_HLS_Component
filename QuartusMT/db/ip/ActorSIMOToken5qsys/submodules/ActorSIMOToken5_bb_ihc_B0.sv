...
module ActorSIMOToken5_bb_ihc_B0 (
    ...
    ActorSIMOToken5_ihc_B0_merge theihc_B0_merge (
    ...
    ActorSIMOToken5_ihc_B0_branch theihc_B0_branch (
    ...
    ActorSIMOToken5_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
