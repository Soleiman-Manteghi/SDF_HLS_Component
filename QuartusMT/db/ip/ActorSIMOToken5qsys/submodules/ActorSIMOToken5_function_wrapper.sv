...
// SystemVerilog created from ActorSIMOToken5_function_wrapper
...
module ActorSIMOToken5_function_wrapper (
    input wire [0:0] avst_iord_bl_call_ActorSIMOToken5_data,
    input wire [0:0] avst_iord_bl_call_ActorSIMOToken5_valid,
    ...
    input wire [0:0] avst_iowr_nb_return_ActorSIMOToken5_almostfull,
    input wire [0:0] avst_iowr_s1_almost_full,
    input wire [0:0] avst_iowr_s1_ready,
    input wire [0:0] stall_in,
    input wire [0:0] start,
    input wire [0:0] valid_in,
    output wire [0:0] avst_iord_bl_call_ActorSIMOToken5_almost_full,
    output wire [0:0] avst_iord_bl_call_ActorSIMOToken5_ready,
    output wire [0:0] avst_iord_bl_s0_almost_full,
    output wire [0:0] avst_iord_bl_s0_ready,
    output wire [0:0] avst_iowr_nb_return_ActorSIMOToken5_data,
    output wire [0:0] avst_iowr_nb_return_ActorSIMOToken5_valid,
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [0:0] ActorSIMOToken5_function_out_iord_bl_call_ActorSIMOToken5_o_fifoalmost_full;
    wire [0:0] ActorSIMOToken5_function_out_iord_bl_call_ActorSIMOToken5_o_fifoready;
    wire [0:0] ActorSIMOToken5_function_out_iowr_bl_call_ihc_1_o_fifodata;
    wire [0:0] ActorSIMOToken5_function_out_iowr_bl_call_ihc_1_o_fifovalid;
    wire [0:0] ActorSIMOToken5_function_out_iowr_bl_call_ihc_2_o_fifodata;
    wire [0:0] ActorSIMOToken5_function_out_iowr_bl_call_ihc_2_o_fifovalid;
    wire [0:0] ActorSIMOToken5_function_out_iowr_bl_call_ihc_o_fifodata;
    wire [0:0] ActorSIMOToken5_function_out_iowr_bl_call_ihc_o_fifovalid;
    wire [0:0] ActorSIMOToken5_function_out_iowr_nb_return_ActorSIMOToken5_o_fifodata;
    wire [0:0] ActorSIMOToken5_function_out_iowr_nb_return_ActorSIMOToken5_o_fifovalid;
    ...
    // iowr_bl_s3_fifo_inst(BLACKBOX,30)
    ActorSIMOToken5_iowr_bl_s3_fifo_inst theiowr_bl_s3_fifo_inst (
    ...
    ActorSIMOToken5_ihc_function theihc_function (
        .in_arg_call(call_const_q),
        .in_arg_s3_global(call_const_q),
        .in_iord_bl_call_ihc_i_fifodata(ActorSIMOToken5_function_out_iowr_bl_call_ihc_o_fifodata),
        .in_iord_bl_call_ihc_i_fifovalid(ActorSIMOToken5_function_out_iowr_bl_call_ihc_o_fifovalid),
    ...
    // iowr_s2_fifo_inst(BLACKBOX,32)
    ActorSIMOToken5_iowr_s2_fifo_inst theiowr_s2_fifo_inst (
    ...
    // iowr_s1_fifo_inst(BLACKBOX,31)
    ActorSIMOToken5_iowr_s1_fifo_inst theiowr_s1_fifo_inst (
    ...
    // iord_bl_s0_fifo_inst(BLACKBOX,29)
    ActorSIMOToken5_iord_bl_s0_fifo_inst theiord_bl_s0_fifo_inst (
    ...
    ActorSIMOToken5_ihc_2_function theihc_2_function (
        .in_arg_call(call_const_q),
        .in_arg_s0_global(call_const_q),
        .in_arg_s1_global(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_iord_bl_call_ihc_2_i_fifodata(ActorSIMOToken5_function_out_iowr_bl_call_ihc_2_o_fifodata),
        .in_iord_bl_call_ihc_2_i_fifovalid(ActorSIMOToken5_function_out_iowr_bl_call_ihc_2_o_fifovalid),
    ...
    ActorSIMOToken5_ihc_1_function theihc_1_function (
        .in_arg_call(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_arg_s3_global(call_const_q),
        .in_iord_bl_call_ihc_1_i_fifodata(ActorSIMOToken5_function_out_iowr_bl_call_ihc_1_o_fifodata),
        .in_iord_bl_call_ihc_1_i_fifovalid(ActorSIMOToken5_function_out_iowr_bl_call_ihc_1_o_fifovalid),
    ...
    // ActorSIMOToken5_function(BLACKBOX,2)
    ActorSIMOToken5_function theActorSIMOToken5_function (
        .in_arg_call(call_const_q),
        .in_arg_return(call_const_q),
        .in_iord_bl_call_ActorSIMOToken5_i_fifodata(avst_iord_bl_call_ActorSIMOToken5_data),
        .in_iord_bl_call_ActorSIMOToken5_i_fifovalid(VCC_q),
        ...
        .in_stall_in(GND_q),
        .in_valid_in(VCC_q),
        .out_iord_bl_call_ActorSIMOToken5_o_fifoalmost_full(ActorSIMOToken5_function_out_iord_bl_call_ActorSIMOToken5_o_fifoalmost_full),
        .out_iord_bl_call_ActorSIMOToken5_o_fifoready(ActorSIMOToken5_function_out_iord_bl_call_ActorSIMOToken5_o_fifoready),
        .out_iowr_bl_call_ihc_1_o_fifodata(ActorSIMOToken5_function_out_iowr_bl_call_ihc_1_o_fifodata),
        .out_iowr_bl_call_ihc_1_o_fifovalid(ActorSIMOToken5_function_out_iowr_bl_call_ihc_1_o_fifovalid),
        .out_iowr_bl_call_ihc_2_o_fifodata(ActorSIMOToken5_function_out_iowr_bl_call_ihc_2_o_fifodata),
        .out_iowr_bl_call_ihc_2_o_fifovalid(ActorSIMOToken5_function_out_iowr_bl_call_ihc_2_o_fifovalid),
        .out_iowr_bl_call_ihc_o_fifodata(ActorSIMOToken5_function_out_iowr_bl_call_ihc_o_fifodata),
        .out_iowr_bl_call_ihc_o_fifovalid(ActorSIMOToken5_function_out_iowr_bl_call_ihc_o_fifovalid),
        .out_iowr_nb_return_ActorSIMOToken5_o_fifodata(ActorSIMOToken5_function_out_iowr_nb_return_ActorSIMOToken5_o_fifodata),
        .out_iowr_nb_return_ActorSIMOToken5_o_fifovalid(ActorSIMOToken5_function_out_iowr_nb_return_ActorSIMOToken5_o_fifovalid),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // avst_iord_bl_call_ActorSIMOToken5_almost_full(GPOUT,33)
    assign avst_iord_bl_call_ActorSIMOToken5_almost_full = ActorSIMOToken5_function_out_iord_bl_call_ActorSIMOToken5_o_fifoalmost_full;

    // avst_iord_bl_call_ActorSIMOToken5_ready(GPOUT,34)
    assign avst_iord_bl_call_ActorSIMOToken5_ready = ActorSIMOToken5_function_out_iord_bl_call_ActorSIMOToken5_o_fifoready;

    // avst_iord_bl_s0_almost_full(GPOUT,35)
    assign avst_iord_bl_s0_almost_full = ihc_2_function_out_iord_bl_s0_o_fifoalmost_full;

    // avst_iord_bl_s0_ready(GPOUT,36)
    assign avst_iord_bl_s0_ready = iord_bl_s0_fifo_inst_out_stream_in_ready;

    // avst_iowr_nb_return_ActorSIMOToken5_data(GPOUT,37)
    assign avst_iowr_nb_return_ActorSIMOToken5_data = ActorSIMOToken5_function_out_iowr_nb_return_ActorSIMOToken5_o_fifodata;

    // avst_iowr_nb_return_ActorSIMOToken5_valid(GPOUT,38)
    assign avst_iowr_nb_return_ActorSIMOToken5_valid = ActorSIMOToken5_function_out_iowr_nb_return_ActorSIMOToken5_o_fifovalid;

    // avst_iowr_s1_data(GPOUT,39)
    assign avst_iowr_s1_data = iowr_s1_fifo_inst_out_stream_out_data;

    // avst_iowr_s1_valid(GPOUT,40)
