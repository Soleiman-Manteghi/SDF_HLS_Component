...
module ActorSIMOToken5_bb_ihc_2_B0_stall_region (
    ...
    // out out_valid_out@2
    ActorSIMOToken5_i_llvm_fpga_push_token_i1_wt_limpush_ihc_20 thei_llvm_fpga_push_token_i1_wt_limpush_ihc_21 (
        .in_data_in(GND_q),
    ...
    // out out_stall_out@20000000
    // out out_valid_out@2
    ActorSIMOToken5_i_llvm_fpga_pop_token_i1_wt_limpop_ihc_20 thei_llvm_fpga_pop_token_i1_wt_limpop_ihc_20 (
        .in_data_in(GND_q),
        .in_dir(GND_q),
    ...
    // out out_stall_out@20000000
    // out out_valid_out@1
    ActorSIMOToken5_ihc_2_B0_merge_reg theihc_2_B0_merge_reg (
        .in_data_in(GND_q),
    ...
    ActorSIMOToken5_i_iord_bl_call_ihc_2_unnamed_ihc_20_ihc_20 thei_iord_bl_call_ihc_2_unnamed_ihc_20_ihc_22 (
