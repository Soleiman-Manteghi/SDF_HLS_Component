...
// SystemVerilog created from i_iowr_nb_return_actorsimotoken5_unnamed_actorsimotoken56_actorsimotoken50
...
module ActorSIMOToken5_i_iowr_nb_return_actorsi0000n56_actorsimotoken50 (
    ...
    assign out_iowr_nb_return_ActorSIMOToken5_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_ActorSIMOToken5_o_fifovalid = iowr_nb_o_fifovalid;
