...
module ActorSIMOToken_bb_ihc_B1 (
    ...
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s0_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s0_o_fifoready;
    ...
    ActorSIMOToken_ihc_B1_branch theihc_B1_branch (
    ...
    ActorSIMOToken_ihc_B1_merge theihc_B1_merge (
    ...
    ActorSIMOToken_bb_ihc_B1_stall_region thebb_ihc_B1_stall_region (
        ...
        .out_iord_bl_s0_o_fifoalmost_full(bb_ihc_B1_stall_region_out_iord_bl_s0_o_fifoalmost_full),
        .out_iord_bl_s0_o_fifoready(bb_ihc_B1_stall_region_out_iord_bl_s0_o_fifoready),
    ...
    assign out_iord_bl_s0_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s0_o_fifoalmost_full;

    // out_iord_bl_s0_o_fifoready(GPOUT,19)
    assign out_iord_bl_s0_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s0_o_fifoready;
