...
module ActorSIMOToken_ihc_function (
    ...
    ActorSIMOToken_i_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc2_valid_fifo (
    ...
    ActorSIMOToken_i_llvm_fpga_pipeline_keep_going_ihc2_sr thei_llvm_fpga_pipeline_keep_going_ihc2_sr (
        .in_i_data(GND_q),
    ...
    ActorSIMOToken_arbiter_iowr_s2 thearbiter_iowr_s2 (
    ...
    ActorSIMOToken_arbiter_iowr_s1 thearbiter_iowr_s1 (
    ...
    ActorSIMOToken_bb_ihc_B1 thebb_ihc_B1 (
        .in_forked_0(GND_q),
    ...
    ActorSIMOToken_bb_ihc_B0 thebb_ihc_B0 (
    ...
    // bb_ihc_B1_sr_1_aunroll_x(BLACKBOX,39)
    ActorSIMOToken_bb_ihc_B1_sr_1 thebb_ihc_B1_sr_1_aunroll_x (
