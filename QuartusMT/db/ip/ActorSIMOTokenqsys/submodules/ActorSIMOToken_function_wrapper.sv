...
// SystemVerilog created from ActorSIMOToken_function_wrapper
...
module ActorSIMOToken_function_wrapper (
    input wire [0:0] avst_iord_bl_call_ActorSIMOToken_data,
    input wire [0:0] avst_iord_bl_call_ActorSIMOToken_valid,
    ...
    input wire [0:0] avst_iowr_nb_return_ActorSIMOToken_almostfull,
    ...
    output wire [0:0] avst_iord_bl_call_ActorSIMOToken_almost_full,
    output wire [0:0] avst_iord_bl_call_ActorSIMOToken_ready,
    output wire [0:0] avst_iord_bl_s0_almost_full,
    output wire [0:0] avst_iord_bl_s0_ready,
    output wire [0:0] avst_iowr_nb_return_ActorSIMOToken_data,
    output wire [0:0] avst_iowr_nb_return_ActorSIMOToken_valid,
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [0:0] ActorSIMOToken_function_out_iord_bl_call_ActorSIMOToken_o_fifoalmost_full;
    wire [0:0] ActorSIMOToken_function_out_iord_bl_call_ActorSIMOToken_o_fifoready;
    wire [0:0] ActorSIMOToken_function_out_iowr_bl_call_ihc_o_fifodata;
    wire [0:0] ActorSIMOToken_function_out_iowr_bl_call_ihc_o_fifovalid;
    wire [0:0] ActorSIMOToken_function_out_iowr_nb_return_ActorSIMOToken_o_fifodata;
    wire [0:0] ActorSIMOToken_function_out_iowr_nb_return_ActorSIMOToken_o_fifovalid;
    ...
    ActorSIMOToken_iowr_s2_fifo_inst theiowr_s2_fifo_inst (
    ...
    ActorSIMOToken_iowr_s1_fifo_inst theiowr_s1_fifo_inst (
    ...
    ActorSIMOToken_iord_bl_s0_fifo_inst theiord_bl_s0_fifo_inst (
    ...
    ActorSIMOToken_ihc_function theihc_function (
        .in_arg_call(call_const_q),
        .in_arg_s0_global(call_const_q),
        .in_arg_s1_global(call_const_q),
        .in_arg_s2_global(call_const_q),
        .in_iord_bl_call_ihc_i_fifodata(ActorSIMOToken_function_out_iowr_bl_call_ihc_o_fifodata),
        .in_iord_bl_call_ihc_i_fifovalid(ActorSIMOToken_function_out_iowr_bl_call_ihc_o_fifovalid),
    ...
    // ActorSIMOToken_function(BLACKBOX,2)
    ActorSIMOToken_function theActorSIMOToken_function (
        .in_arg_call(call_const_q),
        .in_arg_return(call_const_q),
        .in_iord_bl_call_ActorSIMOToken_i_fifodata(avst_iord_bl_call_ActorSIMOToken_data),
        .in_iord_bl_call_ActorSIMOToken_i_fifovalid(VCC_q),
        .in_iowr_bl_call_ihc_i_fifoready(ihc_function_out_iord_bl_call_ihc_o_fifoready),
        .in_stall_in(GND_q),
        .in_valid_in(VCC_q),
        .out_iord_bl_call_ActorSIMOToken_o_fifoalmost_full(ActorSIMOToken_function_out_iord_bl_call_ActorSIMOToken_o_fifoalmost_full),
        .out_iord_bl_call_ActorSIMOToken_o_fifoready(ActorSIMOToken_function_out_iord_bl_call_ActorSIMOToken_o_fifoready),
        .out_iowr_bl_call_ihc_o_fifodata(ActorSIMOToken_function_out_iowr_bl_call_ihc_o_fifodata),
        .out_iowr_bl_call_ihc_o_fifovalid(ActorSIMOToken_function_out_iowr_bl_call_ihc_o_fifovalid),
        .out_iowr_nb_return_ActorSIMOToken_o_fifodata(ActorSIMOToken_function_out_iowr_nb_return_ActorSIMOToken_o_fifodata),
        .out_iowr_nb_return_ActorSIMOToken_o_fifovalid(ActorSIMOToken_function_out_iowr_nb_return_ActorSIMOToken_o_fifovalid),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // avst_iord_bl_call_ActorSIMOToken_almost_full(GPOUT,27)
    assign avst_iord_bl_call_ActorSIMOToken_almost_full = ActorSIMOToken_function_out_iord_bl_call_ActorSIMOToken_o_fifoalmost_full;

    // avst_iord_bl_call_ActorSIMOToken_ready(GPOUT,28)
    assign avst_iord_bl_call_ActorSIMOToken_ready = ActorSIMOToken_function_out_iord_bl_call_ActorSIMOToken_o_fifoready;
    ...
    // avst_iowr_nb_return_ActorSIMOToken_data(GPOUT,31)
    assign avst_iowr_nb_return_ActorSIMOToken_data = ActorSIMOToken_function_out_iowr_nb_return_ActorSIMOToken_o_fifodata;

    // avst_iowr_nb_return_ActorSIMOToken_valid(GPOUT,32)
    assign avst_iowr_nb_return_ActorSIMOToken_valid = ActorSIMOToken_function_out_iowr_nb_return_ActorSIMOToken_o_fifovalid;
