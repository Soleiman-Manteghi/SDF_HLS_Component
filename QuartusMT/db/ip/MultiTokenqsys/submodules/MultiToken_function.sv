...
module MultiToken_function (
    ...
    // bb_MultiToken_B1_start_sr_1_aunroll_x(BLACKBOX,29)
    ...
    // out_iord_bl_call_MultiToken_o_fifoalmost_full(GPOUT,21)
    ...
    // out_iord_bl_call_MultiToken_o_fifoready(GPOUT,22)
