...
module SDF_HLS_component_bb_ihc_B0 (
    ...
    SDF_HLS_component_ihc_B0_merge theihc_B0_merge (
    ...
    SDF_HLS_component_ihc_B0_branch theihc_B0_branch (
    ...
    SDF_HLS_component_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
